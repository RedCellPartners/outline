...
__name(IEnlarge, "IEnlarge");
var testElType = /* @__PURE__ */ __name((type, el) => {
  var _a, _b;
  return type === ((_b = (_a = el == null ? void 0 : el.tagName) == null ? void 0 : _a.toUpperCase) == null ? void 0 : _b.call(_a));
}, "testElType");
var testDiv = /* @__PURE__ */ __name((el) => testElType("DIV", el) || testElType("SPAN", el), "testDiv");
var testImg = /* @__PURE__ */ __name((el) => testElType("IMG", el), "testImg");
var testImgLoaded = /* @__PURE__ */ __name((el) => el.complete && el.naturalHeight !== 0, "testImgLoaded");
var testSvg = /* @__PURE__ */ __name((el) => testElType("SVG", el), "testSvg");
var getScaleToWindow = /* @__PURE__ */ __name(({ height, offset, width }) => {
  return Math.min((window.innerWidth - offset * 2) / width, (window.innerHeight - offset * 2) / height);
}, "getScaleToWindow");
var getScaleToWindowMax = /* @__PURE__ */ __name(({ containerHeight, containerWidth, offset, targetHeight, targetWidth }) => {
...
var getScale = /* @__PURE__ */ __name(({ containerHeight, containerWidth, hasScalableSrc, offset, targetHeight, targetWidth }) => {
...
var URL_REGEX = /url(?:\(['"]?)(.*?)(?:['"]?\))/;
var getImgSrc = /* @__PURE__ */ __name((imgEl) => {
  var _a;
  if (imgEl) {
    if (testImg(imgEl)) {
...
var getImgAlt = /* @__PURE__ */ __name((imgEl) => {
  if (imgEl) {
    if (testImg(imgEl)) {
...
var getImgRegularStyle = /* @__PURE__ */ __name(({ containerHeight, containerLeft, containerTop, containerWidth, hasScalableSrc, offset, targetHeight, targetWidth }) => {
...
var parsePosition = /* @__PURE__ */ __name(({ position, relativeNum }) => {
  const positionNum = parseFloat(position);
  return position.endsWith("%") ? relativeNum * positionNum / 100 : positionNum;
}, "parsePosition");
var getImgObjectFitStyle = /* @__PURE__ */ __name(({ containerHeight, containerLeft, containerTop, containerWidth, hasScalableSrc, objectFit, objectPosition, offset, targetHeight, targetWidth }) => {
...
var getDivImgStyle = /* @__PURE__ */ __name(({ backgroundPosition, backgroundSize, containerHeight, containerLeft, containerTop, containerWidth, hasScalableSrc, offset, targetHeight, targetWidth }) => {
...
var getStyleModalImg = /* @__PURE__ */ __name(({ hasZoomImg, imgSrc, isSvg, isZoomed, loadedImgEl, offset, shouldRefresh, targetEl }) => {
  var _a;
...
var getStyleGhost = /* @__PURE__ */ __name((imgEl) => {
  if (!imgEl) {
    return {};
  }
  if (testSvg(imgEl)) {
...
var adjustSvgIDs = /* @__PURE__ */ __name((svgEl) => {
...
__name(Controlled, "Controlled");
var _ControlledBase = class _ControlledBase extends import_react.default.Component {
  constructor() {
    super(...arguments);
    this.state = {
      id: "",
    ...
    this.setId = () => {
      const gen4 = /* @__PURE__ */ __name(() => Math.random().toString(16).slice(-4), "gen4");
    ...
    this.handleImgLoad = () => {
      ...
      img.src = imgSrc;
      const setLoaded = /* @__PURE__ */ __name(() => {
...
__name(_ControlledBase, "ControlledBase");
var ControlledBase = _ControlledBase;
...
__name(Uncontrolled, "Uncontrolled");
export {
  Controlled,
