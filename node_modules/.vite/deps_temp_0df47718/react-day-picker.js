import {
  ...
  startOfYear,
  subDays
} from "./chunk-CDXDDTSZ.js";
import "./chunk-AEUJTREK.js";
import {
  enUS,
  startOfWeek
...
__name(isDayPickerMultiple, "isDayPickerMultiple");
function isDayPickerRange(props) {
  return props.mode === "range";
}
__name(isDayPickerRange, "isDayPickerRange");
function isDayPickerSingle(props) {
  return props.mode === "single";
}
__name(isDayPickerSingle, "isDayPickerSingle");
...
__name(formatCaption, "formatCaption");
...
__name(formatMonthCaption, "formatMonthCaption");
function formatWeekNumber(weekNumber) {
  return "".concat(weekNumber);
}
__name(formatWeekNumber, "formatWeekNumber");
function formatWeekdayName(weekday, options) {
  return format(weekday, "cccccc", options);
}
__name(formatWeekdayName, "formatWeekdayName");
function formatYearCaption(year, options) {
  return format(year, "yyyy", options);
}
__name(formatYearCaption, "formatYearCaption");
...
var labelDay = /* @__PURE__ */ __name(function(day, activeModifiers, options) {
  return format(day, "do MMMM (EEEE)", options);
}, "labelDay");
var labelMonthDropdown = /* @__PURE__ */ __name(function() {
  return "Month: ";
}, "labelMonthDropdown");
var labelNext = /* @__PURE__ */ __name(function() {
  return "Go to next month";
}, "labelNext");
var labelPrevious = /* @__PURE__ */ __name(function() {
  return "Go to previous month";
}, "labelPrevious");
var labelWeekday = /* @__PURE__ */ __name(function(day, options) {
  return format(day, "cccc", options);
}, "labelWeekday");
var labelWeekNumber = /* @__PURE__ */ __name(function(n) {
  return "Week n. ".concat(n);
}, "labelWeekNumber");
var labelYearDropdown = /* @__PURE__ */ __name(function() {
  return "Year: ";
}, "labelYearDropdown");
...
__name(getDefaultContextValues, "getDefaultContextValues");
...
__name(parseFromToProps, "parseFromToProps");
...
__name(DayPickerProvider, "DayPickerProvider");
...
__name(IconDropdown, "IconDropdown");
...
__name(getDisplayMonths, "getDisplayMonths");
...
function NavigationProvider(props) {
  ...
  var isDateDisplayed = /* @__PURE__ */ __name(function(date) {
    return displayMonths.some(function(displayMonth) {
      return isSameMonth(date, displayMonth);
    });
  }, "isDateDisplayed");
  var goToDate = /* @__PURE__ */ __name(function(date, refDate) {
...
function CaptionDropdowns(props) {
  ...
  var handleMonthChange = /* @__PURE__ */ __name(function(newMonth) {
...
__name(CaptionDropdowns, "CaptionDropdowns");
...
function CaptionNavigation(props) {
  ...
  var handlePreviousClick = /* @__PURE__ */ __name(function() {
    if (!previousMonth)
      return;
    goToMonth(previousMonth);
  }, "handlePreviousClick");
  var handleNextClick = /* @__PURE__ */ __name(function() {
    if (!nextMonth)
      return;
    goToMonth(nextMonth);
  }, "handleNextClick");
...
__name(CaptionNavigation, "CaptionNavigation");
...
__name(SelectMultipleProvider, "SelectMultipleProvider");
function SelectMultipleProviderInternal(_a) {
  var initialProps = _a.initialProps, children = _a.children;
  var selected = initialProps.selected, min2 = initialProps.min, max2 = initialProps.max;
  var onDayClick = /* @__PURE__ */ __name(function(day, activeModifiers, e) {
    var _a2, _b;
...
__name(SelectMultipleProviderInternal, "SelectMultipleProviderInternal");
...
__name(useSelectMultiple, "useSelectMultiple");
...
__name(SelectRangeProvider, "SelectRangeProvider");
...
__name(SelectRangeProviderInternal, "SelectRangeProviderInternal");
...
__name(useSelectRange, "useSelectRange");
...
__name(matcherToArray, "matcherToArray");
...
__name(getCustomModifiers, "getCustomModifiers");
...
__name(getInternalModifiers, "getInternalModifiers");
...
__name(ModifiersProvider, "ModifiersProvider");
...
__name(useModifiers, "useModifiers");
function isDateInterval(matcher) {
  return Boolean(matcher && typeof matcher === "object" && "before" in matcher && "after" in matcher);
}
__name(isDateInterval, "isDateInterval");
function isDateRange(value) {
  return Boolean(value && typeof value === "object" && "from" in value);
}
__name(isDateRange, "isDateRange");
function isDateAfterType(value) {
  return Boolean(value && typeof value === "object" && "after" in value);
}
__name(isDateAfterType, "isDateAfterType");
function isDateBeforeType(value) {
  return Boolean(value && typeof value === "object" && "before" in value);
}
__name(isDateBeforeType, "isDateBeforeType");
function isDayOfWeekType(value) {
  return Boolean(value && typeof value === "object" && "dayOfWeek" in value);
}
__name(isDayOfWeekType, "isDayOfWeekType");
...
__name(isDateType, "isDateType");
function isArrayOfDates(value) {
  return Array.isArray(value) && value.every(isDate);
}
__name(isArrayOfDates, "isArrayOfDates");
...
__name(getActiveModifiers, "getActiveModifiers");
...
__name(getInitialFocusTarget, "getInitialFocusTarget");
var MAX_RETRY = 365;
function getNextFocus(focusedDay, options) {
  ...
  var moveFns = {
    ...
    month: addMonths,
    year: addYears,
    startOfWeek: /* @__PURE__ */ __name(function(date) {
      return context.ISOWeek ? startOfISOWeek(date) : startOfWeek(date, { locale, weekStartsOn });
    }, "startOfWeek"),
    endOfWeek: /* @__PURE__ */ __name(function(date) {
...
__name(getNextFocus, "getNextFocus");
...
function FocusProvider(props) {
  ...
  var blur = /* @__PURE__ */ __name(function() {
    setLastFocused(focusedDay);
    setFocusedDay(void 0);
  }, "blur");
  var focus = /* @__PURE__ */ __name(function(date) {
    setFocusedDay(date);
  }, "focus");
  var context = useDayPicker();
  var moveFocus = /* @__PURE__ */ __name(function(moveBy, direction) {
    if (!focusedDay)
      return;
  ...
  var value = {
    ...
    blur,
    focus,
    focusDayAfter: /* @__PURE__ */ __name(function() {
      return moveFocus("day", "after");
    }, "focusDayAfter"),
    focusDayBefore: /* @__PURE__ */ __name(function() {
      return moveFocus("day", "before");
    }, "focusDayBefore"),
    focusWeekAfter: /* @__PURE__ */ __name(function() {
      return moveFocus("week", "after");
    }, "focusWeekAfter"),
    focusWeekBefore: /* @__PURE__ */ __name(function() {
      return moveFocus("week", "before");
    }, "focusWeekBefore"),
    focusMonthBefore: /* @__PURE__ */ __name(function() {
      return moveFocus("month", "before");
    }, "focusMonthBefore"),
    focusMonthAfter: /* @__PURE__ */ __name(function() {
      return moveFocus("month", "after");
    }, "focusMonthAfter"),
    focusYearBefore: /* @__PURE__ */ __name(function() {
      return moveFocus("year", "before");
    }, "focusYearBefore"),
    focusYearAfter: /* @__PURE__ */ __name(function() {
      return moveFocus("year", "after");
    }, "focusYearAfter"),
    focusStartOfWeek: /* @__PURE__ */ __name(function() {
      return moveFocus("startOfWeek", "before");
    }, "focusStartOfWeek"),
    focusEndOfWeek: /* @__PURE__ */ __name(function() {
      return moveFocus("endOfWeek", "after");
    }, "focusEndOfWeek")
  };
  return (0, import_jsx_runtime.jsx)(FocusContext.Provider, { value, children: props.children });
}
__name(FocusProvider, "FocusProvider");
...
__name(useFocusContext, "useFocusContext");
function useActiveModifiers(day, displayMonth) {
  var modifiers = useModifiers();
  var activeModifiers = getActiveModifiers(day, modifiers, displayMonth);
  return activeModifiers;
}
__name(useActiveModifiers, "useActiveModifiers");
...
__name(SelectSingleProvider, "SelectSingleProvider");
...
__name(SelectSingleProviderInternal, "SelectSingleProviderInternal");
...
__name(useSelectSingle, "useSelectSingle");
function useDayEventHandlers(date, activeModifiers) {
  ...
  var onClick = /* @__PURE__ */ __name(function(e) {
    var _a2, _b, _c, _d;
...
__name(useDayEventHandlers, "useDayEventHandlers");
...
__name(useSelectedDays, "useSelectedDays");
function isInternalModifier(modifier) {
  return Object.values(InternalModifier).includes(modifier);
}
__name(isInternalModifier, "isInternalModifier");
...
__name(getDayClassNames, "getDayClassNames");
...
__name(getDayStyle, "getDayStyle");
...
__name(useDayRender, "useDayRender");
function Day(props) {
...
function WeekNumber(props) {
  ...
  var handleClick = /* @__PURE__ */ __name(function(e) {
...
__name(daysToMonthWeeks, "daysToMonthWeeks");
...
__name(getMonthWeeks, "getMonthWeeks");
...
function useInput(options) {
  ...
  var parseValue = /* @__PURE__ */ __name(function(value) {
  ...
  var setSelected = /* @__PURE__ */ __name(function(date) {
    setSelectedDay(date);
    setMonth2(date !== null && date !== void 0 ? date : today);
    setInputValue(date ? format(date, format$1, { locale }) : "");
  }, "setSelected");
  var handleDayClick = /* @__PURE__ */ __name(function(day, _a2) {
  ...
  var handleMonthChange = /* @__PURE__ */ __name(function(month2) {
    setMonth2(month2);
  }, "handleMonthChange");
  var handleChange = /* @__PURE__ */ __name(function(e) {
  ...
  var handleBlur = /* @__PURE__ */ __name(function(e) {
    var day = parseValue(e.target.value);
    if (!isValidDate(day)) {
      reset();
    }
  }, "handleBlur");
  var handleFocus = /* @__PURE__ */ __name(function(e) {
    if (!e.target.value) {
      reset();
      return;
    }
...
__name(isDayPickerDefault, "isDayPickerDefault");
export {
  Button,
  Caption,
  CaptionDropdowns,
