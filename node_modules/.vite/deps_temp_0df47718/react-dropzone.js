...
__name(toFileWithPath, "toFileWithPath");
...
__name(withMimeType, "withMimeType");
...
__name(isDataTransfer, "isDataTransfer");
function isChangeEvt(value) {
  return isObject(value) && isObject(value.target);
}
__name(isChangeEvt, "isChangeEvt");
function isObject(v) {
...
__name(getDataTransferFiles, "getDataTransferFiles");
function noIgnoredFiles(files) {
  return files.filter(function(file) {
    return FILES_TO_IGNORE.indexOf(file.name) === -1;
  });
}
__name(noIgnoredFiles, "noIgnoredFiles");
...
__name(toFilePromises, "toFilePromises");
...
__name(fromDataTransferItem, "fromDataTransferItem");
...
__name(fromDirEntry, "fromDirEntry");
...
__name(fromFileEntry, "fromFileEntry");
...
var getInvalidTypeRejectionErr = /* @__PURE__ */ __name(function getInvalidTypeRejectionErr2(accept) {
...
var getTooLargeRejectionErr = /* @__PURE__ */ __name(function getTooLargeRejectionErr2(maxSize) {
  return {
    code: FILE_TOO_LARGE,
    message: "File is larger than ".concat(maxSize, " ").concat(maxSize === 1 ? "byte" : "bytes")
  };
}, "getTooLargeRejectionErr");
var getTooSmallRejectionErr = /* @__PURE__ */ __name(function getTooSmallRejectionErr2(minSize) {
  return {
    code: FILE_TOO_SMALL,
...
__name(fileAccepted, "fileAccepted");
...
__name(fileMatchSize, "fileMatchSize");
...
__name(allFilesAccepted, "allFilesAccepted");
...
__name(onDocumentDragOver, "onDocumentDragOver");
...
__name(canUseFileSystemAccessAPI, "canUseFileSystemAccessAPI");
...
function useDropzone() {
  ...
  var onDocumentDrop = /* @__PURE__ */ __name(function onDocumentDrop2(event) {
  ...
  var composeHandler = /* @__PURE__ */ __name(function composeHandler2(fn) {
    return disabled ? null : fn;
  }, "composeHandler");
  var composeKeyboardHandler = /* @__PURE__ */ __name(function composeKeyboardHandler2(fn) {
    return noKeyboard ? null : composeHandler(fn);
  }, "composeKeyboardHandler");
  var composeDragHandler = /* @__PURE__ */ __name(function composeDragHandler2(fn) {
