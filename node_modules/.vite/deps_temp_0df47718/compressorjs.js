...
var isBlob = /* @__PURE__ */ __name(function isBlob2(value) {
...
var isPositiveNumber = /* @__PURE__ */ __name(function isPositiveNumber2(value) {
...
__name(isImageType, "isImageType");
...
__name(imageTypeToExtension, "imageTypeToExtension");
...
__name(getStringFromCharCode, "getStringFromCharCode");
...
__name(arrayBufferToDataURL, "arrayBufferToDataURL");
...
__name(resetAndGetOrientation, "resetAndGetOrientation");
...
__name(parseOrientation, "parseOrientation");
var REGEXP_DECIMALS = /\.\d*(?:0|9){12}\d*$/;
function normalizeDecimalNumber(value) {
  var times = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1e11;
  return REGEXP_DECIMALS.test(value) ? Math.round(value * times) / times : value;
}
__name(normalizeDecimalNumber, "normalizeDecimalNumber");
...
__name(getAdjustedSizes, "getAdjustedSizes");
...
var Compressor = function() {
  ...
  _createClass(Compressor2, [{
    ...
    key: "load",
    value: /* @__PURE__ */ __name(function load(data) {
      var _this2 = this;
    ...
    key: "draw",
    value: /* @__PURE__ */ __name(function draw(_ref2) {
      var _this3 = this;
      ...
      var callback = /* @__PURE__ */ __name(function callback2(blob) {
        if (!_this3.aborted) {
          var done = /* @__PURE__ */ __name(function done2(result) {
            return _this3.done({
              naturalWidth,
              naturalHeight,
              result
          ...
          if (blob && isJPEGImage && options.retainExif && _this3.exif && _this3.exif.length > 0) {
            var next = /* @__PURE__ */ __name(function next2(arrayBuffer) {
    ...
    key: "done",
    value: /* @__PURE__ */ __name(function done(_ref8) {
    ...
    key: "fail",
    value: /* @__PURE__ */ __name(function fail(err) {
    ...
    key: "noConflict",
    value: /* @__PURE__ */ __name(function noConflict() {
    ...
    key: "setDefaults",
    value: /* @__PURE__ */ __name(function setDefaults(options) {
