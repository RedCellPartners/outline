...
// node_modules/@benrbray/prosemirror-math/dist/index.es.js
...
__name(collapseMathCmd, "collapseMathCmd");
var _MathView = class _MathView {
  // == Lifecycle ===================================== //
  /**
  ...
  openEditor() {
    ...
    this._innerView = new EditorView(this._mathSrcElt, {
      state: EditorState.create({
        doc: this._node,
        plugins: [keymap({
          "Tab": /* @__PURE__ */ __name((state, dispatch) => {
            if (dispatch) {
          ...
          "Ctrl-Backspace": /* @__PURE__ */ __name((state, dispatch, tr_inner) => {
            this._outerView.dispatch(this._outerView.state.tr.insertText(""));
            this._outerView.focus();
            return true;
          }, "Ctrl-Backspace"),
...
__name(_MathView, "MathView");
var MathView = _MathView;
...
function createMathView(displayMode) {
  return (node, view, getPos) => {
    ...
    let nodeView = new MathView(node, view, getPos, { katexOptions: { displayMode, macros: pluginState.macros } }, MATH_PLUGIN_KEY, () => {
...
__name(createMathView, "createMathView");
var mathPluginSpec = {
  key: MATH_PLUGIN_KEY,
  state: {
...
var mathPlugin = new Plugin(mathPluginSpec);
...
__name(getFirstMatch, "getFirstMatch");
function makeTextFragment(text2, schema) {
  return Fragment.from(schema.text(text2));
}
__name(makeTextFragment, "makeTextFragment");
...
__name(texFromMediaWikiFallbackImage, "texFromMediaWikiFallbackImage");
...
__name(texFromMathML_01, "texFromMathML_01");
...
__name(texFromMathML_02, "texFromMathML_02");
...
__name(matchWikipedia, "matchWikipedia");
var wikipediaBlockMathParseRule = {
  tag: "dl",
  getAttrs(p) {
    let dl = p;
...
var wikipediaInlineMathParseRule = {
  tag: "span",
  getAttrs(p) {
    let span = p;
...
var defaultInlineMathParseRules = [
  wikipediaInlineMathParseRule
];
var defaultBlockMathParseRules = [
  wikipediaBlockMathParseRule
];
function createSchemaSpec(spec) {
  return spec;
}
__name(createSchemaSpec, "createSchemaSpec");
var mathSchemaSpec = createSchemaSpec({
  nodes: {
    ...
    math_inline: {
      ...
      inline: true,
      atom: true,
      toDOM: /* @__PURE__ */ __name(() => ["math-inline", { class: "math-node" }, 0], "toDOM"),
      parseDOM: [
        { tag: "math-inline" },
    ...
    math_display: {
      ...
      atom: true,
      code: true,
      toDOM: /* @__PURE__ */ __name(() => ["math-display", { class: "math-node" }, 0], "toDOM"),
      parseDOM: [
        { tag: "math-display" },
...
__name(createMathSchema, "createMathSchema");
var mathBackspaceCmd = /* @__PURE__ */ __name((state, dispatch) => {
...
var REGEX_INLINE_MATH_DOLLARS = /\$(.+)\$/;
var REGEX_INLINE_MATH_DOLLARS_ESCAPED = (() => {
  try {
    return new RegExp("(?<!\\\\)\\$(.+)(?<!\\\\)\\$");
  } catch (e) {
...
var REGEX_BLOCK_MATH_DOLLARS = /\$\$\s+$/;
...
__name(makeInlineMathInputRule, "makeInlineMathInputRule");
function makeBlockMathInputRule(pattern, nodeType, getAttrs) {
  return new InputRule(pattern, (state, match, start, end) => {
    ...
    if (!$start.node(-1).canReplaceWith($start.index(-1), $start.indexAfter(-1), nodeType))
      return null;
    let tr = state.tr.delete(start, end).setBlockType(start, start, nodeType, attrs);
    return tr.setSelection(NodeSelection.create(tr.doc, tr.mapping.map($start.pos - 1)));
  });
}
__name(makeBlockMathInputRule, "makeBlockMathInputRule");
var checkSelection = /* @__PURE__ */ __name((arg) => {
...
var mathSelectPlugin = new Plugin({
  state: {
...
__name(insertMathCmd, "insertMathCmd");
var _ProseMirrorTextSerializer = class _ProseMirrorTextSerializer {
  ...
  serializeFragment(fragment) {
    ...
    fragment.nodesBetween(from, to, (node, pos) => {
      ...
      if (node.isText) {
        text2 += ((_a = node.text) === null || _a === void 0 ? void 0 : _a.slice(Math.max(from, pos) - pos, to - pos)) || "";
...
__name(_ProseMirrorTextSerializer, "ProseMirrorTextSerializer");
var ProseMirrorTextSerializer = _ProseMirrorTextSerializer;
var mathSerializer = new ProseMirrorTextSerializer({
  nodes: {
    "math_inline": /* @__PURE__ */ __name((node) => `$${node.textContent}$`, "math_inline"),
    "math_display": /* @__PURE__ */ __name((node) => `
...
//# sourceMappingURL=@benrbray_prosemirror-math.js.map
