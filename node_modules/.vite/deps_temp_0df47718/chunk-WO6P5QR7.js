...
__name(getRelativeTransformOrigin, "getRelativeTransformOrigin");
...
__name(isPointWithinRect, "isPointWithinRect");
var pointerWithin = /* @__PURE__ */ __name((_ref) => {
  let {
    droppableContainers,
    droppableRects,
    pointerCoordinates
...
var DndContext = (0, import_react2.memo)(/* @__PURE__ */ __name(function DndContext2(_ref) {
...
__name(NullifiedContextProvider, "NullifiedContextProvider");
var baseStyles = {
  position: "fixed",
  touchAction: "none"
};
var defaultTransition = /* @__PURE__ */ __name((activatorEvent) => {
...
var defaultDropAnimationSideEffects = /* @__PURE__ */ __name((options) => (_ref) => {
  let {
    active,
    dragOverlay
  } = _ref;
...
var defaultKeyframeResolver = /* @__PURE__ */ __name((_ref2) => {
  let {
    transform: {
      initial,
      final
...
__name(useDropAnimation, "useDropAnimation");
...
__name(createDefaultDropAnimation, "createDefaultDropAnimation");
var key = 0;
function useKey(id) {
  return (0, import_react2.useMemo)(() => {
    if (id == null) {
...
//# sourceMappingURL=chunk-WO6P5QR7.js.map
