...
var It = /* @__PURE__ */ __name(({ visible: c }) => import_react2.default.createElement("div", { className: "sonner-loading-wrapper", "data-visible": c }, import_react2.default.createElement("div", { className: "sonner-spinner" }, zt.map((a, t) => import_react2.default.createElement("div", { className: "sonner-loading-bar", key: `spinner-bar-${t}` })))), "It");
...
var Qt = /* @__PURE__ */ __name((c) => {
  ...
  import_react.default.useEffect(() => {
    if (t.promise && b === "loading" || t.duration === 1 / 0 || t.type === "loading") return;
    let o, d = ft;
    return F || v || X && ht ? (() => {
  ...
  }, "onPointerUp"), onPointerMove: /* @__PURE__ */ __name((o) => {
    var St;
...
var fe = /* @__PURE__ */ __name((c) => {
  ...
  return import_react.default.useEffect(() => E.subscribe((l) => {
    ...
    var w;
    let [h, D] = l.split("-");
    return import_react.default.createElement("ol", { key: l, dir: V === "auto" ? Nt() : V, tabIndex: -1, ref: C, className: f, "data-sonner-toaster": true, "data-theme": G, "data-rich-colors": Q, "data-y-position": h, "data-x-position": D, style: { "--front-toast-height": `${((w = x[0]) == null ? void 0 : w.height) || 0}px`, "--offset": typeof m == "number" ? `${m}px` : m || Kt, "--width": `${Jt}px`, "--gap": `${Dt}px`, ...U }, onBlur: /* @__PURE__ */ __name((u) => {
    ...
    }, "onBlur"), onFocus: /* @__PURE__ */ __name((u) => {
      u.target instanceof HTMLElement && u.target.dataset.dismissible === "false" || A.current || (A.current = true, B.current = u.relatedTarget);
    }, "onFocus"), onMouseEnter: /* @__PURE__ */ __name(() => T(true), "onMouseEnter"), onMouseMove: /* @__PURE__ */ __name(() => T(true), "onMouseMove"), onMouseLeave: /* @__PURE__ */ __name(() => {
      L || T(false);
    }, "onMouseLeave"), onPointerDown: /* @__PURE__ */ __name((u) => {
      u.target instanceof HTMLElement && u.target.dataset.dismissible === "false" || J(true);
    }, "onPointerDown"), onPointerUp: /* @__PURE__ */ __name(() => J(false), "onPointerUp") }, I.filter((u) => !u.position && p === 0 || u.position === l).map((u, $) => {
      var b, P;
