...
var Portal2 = function(_React$Component) {
  ...
  _createClass2(Portal4, [{
    ...
    value: /* @__PURE__ */ __name(function componentDidUpdate(props) {
      this.renderPortal();
    }, "componentDidUpdate")
  }, {
    key: "componentWillUnmount",
    ...
    key: "renderPortal",
    value: /* @__PURE__ */ __name(function renderPortal(props) {
      if (!this.props.node && !this.defaultNode) {
        this.defaultNode = document.createElement("div");
        document.body.appendChild(this.defaultNode);
      }
...
var PortalWithState = function(_React$Component) {
  ...
  __name(PortalWithState2, "PortalWithState");
  _createClass3(PortalWithState2, [{
    ...
    key: "openPortal",
    value: /* @__PURE__ */ __name(function openPortal(e) {
    ...
    key: "closePortal",
    value: /* @__PURE__ */ __name(function closePortal() {
      if (!this.state.active) {
        return;
      }
    ...
    key: "wrapWithPortal",
    value: /* @__PURE__ */ __name(function wrapWithPortal(children) {
      var _this2 = this;
      if (!this.state.active) {
        return null;
      }
      return import_react3.default.createElement(
        PortalCompat_default,
        {
          ...
          key: "react-portal",
          ref: /* @__PURE__ */ __name(function ref(portalNode) {
    ...
    value: /* @__PURE__ */ __name(function handleOutsideMouseClick(e) {
      if (!this.state.active) {
        return;
      }
    ...
    key: "handleKeydown",
    value: /* @__PURE__ */ __name(function handleKeydown(e) {
...
PortalWithState.defaultProps = {
  onOpen: /* @__PURE__ */ __name(function onOpen() {
  }, "onOpen"),
  onClose: /* @__PURE__ */ __name(function onClose() {
  }, "onClose")
};
