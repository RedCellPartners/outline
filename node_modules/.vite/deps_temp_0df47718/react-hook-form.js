...
var useFormContext = /* @__PURE__ */ __name(() => import_react.default.useContext(HookFormContext), "useFormContext");
...
function Form(props) {
  ...
  const submit = /* @__PURE__ */ __name(async (event) => {
    let hasError = false;
    let type = "";
...
var getFocusFieldName = /* @__PURE__ */ __name((name, index, options = {}) => options.shouldFocus || isUndefined(options.shouldFocus) ? options.focusName || `${name}.${isUndefined(options.focusIndex) ? index : options.focusIndex}.` : "", "getFocusFieldName");
...
var validateField = /* @__PURE__ */ __name(async (field, formValues, validateAllFieldCriteria, shouldUseNativeValidation, isFieldArray) => {
...
var appendAt = /* @__PURE__ */ __name((data, value) => [
  ...data,
  ...convertToArrayPayload(value)
], "appendAt");
var fillEmptyArray = /* @__PURE__ */ __name((value) => Array.isArray(value) ? value.map(() => void 0) : void 0, "fillEmptyArray");
...
var prependAt = /* @__PURE__ */ __name((data, value) => [
  ...convertToArrayPayload(value),
...
var removeArrayAt = /* @__PURE__ */ __name((data, index) => isUndefined(index) ? [] : removeAtIndexes(data, convertToArrayPayload(index).sort((a, b) => a - b)), "removeArrayAt");
...
__name(unset, "unset");
var updateAt = /* @__PURE__ */ __name((fieldValues, index, value) => {
...
function useFieldArray(props) {
  ...
  useSubscribe({
    next: /* @__PURE__ */ __name(({ values, name: fieldArrayName }) => {
  ...
  const append = /* @__PURE__ */ __name((value, options) => {
  ...
  const prepend = /* @__PURE__ */ __name((value, options) => {
  ...
  const update = /* @__PURE__ */ __name((index, value) => {
  ...
  const replace = /* @__PURE__ */ __name((value) => {
...
__name(useFieldArray, "useFieldArray");
...
function createFormControl(props = {}) {
  ...
  const _updateValid = /* @__PURE__ */ __name(async (shouldUpdateValid) => {
  ...
  const _updateFieldArray = /* @__PURE__ */ __name((name, values = [], method, args, shouldSetValues = true, shouldUpdateFieldsAndState = true) => {
    if (args && method) {
      _state.action = true;
  ...
  const _executeSchema = /* @__PURE__ */ __name(async (name) => {
  ...
  const _getDirty = /* @__PURE__ */ __name((name, data) => (name && data && set(_formValues, name, data), !deepEqual(getValues(), _defaultValues)), "_getDirty");
  ...
  const _getFieldArray = /* @__PURE__ */ __name((name) => compact(get(_state.mount ? _formValues : _defaultValues, name, props.shouldUnregister ? get(_defaultValues, name, []) : [])), "_getFieldArray");
  ...
  const onChange = /* @__PURE__ */ __name(async (event) => {
    ...
    const field = get(_fields, name);
    const getCurrentFieldValue = /* @__PURE__ */ __name(() => target.type ? getFieldValue(field._f) : getEventValue(event), "getCurrentFieldValue");
  ...
  const watch = /* @__PURE__ */ __name((name, defaultValue) => isFunction(name) ? _subjects.values.subscribe({
    next: /* @__PURE__ */ __name((payload) => name(_getWatch(void 0, defaultValue), payload), "next")
  ...
  const _updateDisabledField = /* @__PURE__ */ __name(({ disabled, name, field, fields, value }) => {
  ...
  const _updateFormState = /* @__PURE__ */ __name((updatedFormState) => {
    _formState = {
      ..._formState,
      ...updatedFormState
    };
