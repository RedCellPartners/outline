...
var writeBinaryEncoder = /* @__PURE__ */ __name((encoder, append2) => writeUint8Array(encoder, toUint8Array(append2)), "writeBinaryEncoder");
...
var oneOf = /* @__PURE__ */ __name((arr) => arr[floor(rand() * arr.length)], "oneOf");
...
var equalFlat = /* @__PURE__ */ __name((a, b) => a === b || length2(a) === length2(b) && every(a, (val, key) => (val !== void 0 || hasProperty(b, key)) && b[key] === val), "equalFlat");
...
var createTimeoutClass = /* @__PURE__ */ __name((clearFunction) => {
  var _a;
  return _a = class {
    /**
...
var timeout = /* @__PURE__ */ __name((timeout2, callback) => new Timeout(setTimeout(callback, timeout2)), "timeout");
...
var _AbstractConnector = class _AbstractConnector extends Observable {
  /**
   * @param {Doc} ydoc
   * @param {any} awareness
   */
...
__name(_AbstractConnector, "AbstractConnector");
var AbstractConnector = _AbstractConnector;
...
var _Doc = class _Doc extends Observable {
  /**
...
var readUpdate = /* @__PURE__ */ __name((decoder, ydoc, transactionOrigin) => readUpdateV2(decoder, ydoc, transactionOrigin, new UpdateDecoderV1(decoder)), "readUpdate");
...
var writeID = /* @__PURE__ */ __name((encoder, id2) => {
  writeVarUint(encoder, id2.client);
  writeVarUint(encoder, id2.clock);
}, "writeID");
var readID = /* @__PURE__ */ __name((decoder) => createID(readVarUint(decoder), readVarUint(decoder)), "readID");
...
var logType = /* @__PURE__ */ __name((type) => {
  const res = [];
  let n = type._start;
  while (n) {
    res.push(n);
...
var _PermanentUserData = class _PermanentUserData {
  /**
   * @param {Doc} doc
  ...
  constructor(doc2, storeType = doc2.getMap("users")) {
    ...
    this.clients = /* @__PURE__ */ new Map();
    this.dss = dss;
    const initUser = /* @__PURE__ */ __name((user, userDescription) => {
      const ds = user.get("ds");
      const ids = user.get("ids");
      const addClientId = (
        /** @param {number} clientid */
        /* @__PURE__ */ __name((clientid) => this.clients.set(clientid, userDescription), "addClientId")
      );
      ds.observe(
   ...
   */
  setUserMapping(doc2, clientid, userDescription, { filter = /* @__PURE__ */ __name(() => true, "filter") } = {}) {
...
__name(_PermanentUserData, "PermanentUserData");
var PermanentUserData = _PermanentUserData;
...
var writeRelativePosition = /* @__PURE__ */ __name((encoder, rpos) => {
...
var encodeRelativePosition = /* @__PURE__ */ __name((rpos) => {
  const encoder = createEncoder();
  writeRelativePosition(encoder, rpos);
  return toUint8Array(encoder);
}, "encodeRelativePosition");
var readRelativePosition = /* @__PURE__ */ __name((decoder) => {
  let type = null;
  let tname = null;
  let itemID = null;
...
var decodeRelativePosition = /* @__PURE__ */ __name((uint8Array) => readRelativePosition(createDecoder(uint8Array)), "decodeRelativePosition");
...
var equalSnapshots = /* @__PURE__ */ __name((snap1, snap2) => {
...
var encodeSnapshotV2 = /* @__PURE__ */ __name((snapshot2, encoder = new DSEncoderV2()) => {
  writeDeleteSet(encoder, snapshot2.ds);
  writeStateVector(encoder, snapshot2.sv);
  return encoder.toUint8Array();
}, "encodeSnapshotV2");
var encodeSnapshot = /* @__PURE__ */ __name((snapshot2) => encodeSnapshotV2(snapshot2, new DSEncoderV1()), "encodeSnapshot");
var decodeSnapshotV2 = /* @__PURE__ */ __name((buf, decoder = new DSDecoderV2(createDecoder(buf))) => {
  return new Snapshot(readDeleteSet(decoder), readStateVector(decoder));
}, "decodeSnapshotV2");
var decodeSnapshot = /* @__PURE__ */ __name((buf) => decodeSnapshotV2(buf, new DSDecoderV1(createDecoder(buf))), "decodeSnapshot");
var createSnapshot = /* @__PURE__ */ __name((ds, sm) => new Snapshot(ds, sm), "createSnapshot");
var emptySnapshot = createSnapshot(createDeleteSet(), /* @__PURE__ */ new Map());
var snapshot = /* @__PURE__ */ __name((doc2) => createSnapshot(createDeleteSetFromStructStore(doc2.store), getStateVector(doc2.store)), "snapshot");
var isVisible = /* @__PURE__ */ __name((item, snapshot2) => snapshot2 === void 0 ? !item.deleted : snapshot2.sv.has(item.id.client) && (snapshot2.sv.get(item.id.client) || 0) > item.id.clock && !isDeleted(snapshot2.ds, item.id), "isVisible");
var splitSnapshotAffectedStructs = /* @__PURE__ */ __name((transaction, snapshot2) => {
...
var createDocFromSnapshot = /* @__PURE__ */ __name((originDoc, snapshot2, newDoc = new Doc()) => {
  if (originDoc.gc) {
...
var tryGc = /* @__PURE__ */ __name((ds, store, gcFilter) => {
...
var _StackItem = class _StackItem {
  /**
...
__name(_StackItem, "StackItem");
var StackItem = _StackItem;
...
var _UndoManager = class _UndoManager extends Observable {
  /**
...
__name(_UndoManager, "UndoManager");
...
var logUpdate = /* @__PURE__ */ __name((update) => logUpdateV2(update, UpdateDecoderV1), "logUpdate");
var logUpdateV2 = /* @__PURE__ */ __name((update, YDecoder = UpdateDecoderV2) => {
  const structs = [];
...
var decodeUpdate = /* @__PURE__ */ __name((update) => decodeUpdateV2(update, UpdateDecoderV1), "decodeUpdate");
var decodeUpdateV2 = /* @__PURE__ */ __name((update, YDecoder = UpdateDecoderV2) => {
  const structs = [];
  const updateDecoder = new YDecoder(createDecoder(update));
  const lazyDecoder = new LazyStructReader(updateDecoder, false);
  for (let curr = lazyDecoder.curr; curr !== null; curr = lazyDecoder.next()) {
...
var encodeStateVectorFromUpdateV2 = /* @__PURE__ */ __name((update, YEncoder = DSEncoderV2, YDecoder = UpdateDecoderV2) => {
...
var encodeStateVectorFromUpdate = /* @__PURE__ */ __name((update) => encodeStateVectorFromUpdateV2(update, DSEncoderV1, UpdateDecoderV1), "encodeStateVectorFromUpdate");
var parseUpdateMetaV2 = /* @__PURE__ */ __name((update, YDecoder = UpdateDecoderV2) => {
...
var parseUpdateMeta = /* @__PURE__ */ __name((update) => parseUpdateMetaV2(update, UpdateDecoderV1), "parseUpdateMeta");
...
var diffUpdate = /* @__PURE__ */ __name((update, sv) => diffUpdateV2(update, sv, UpdateDecoderV1, UpdateEncoderV1), "diffUpdate");
...
var createObfuscator = /* @__PURE__ */ __name(({ formatting = true, subdocs = true, yxml = true } = {}) => {
  let i = 0;
...
var obfuscateUpdate = /* @__PURE__ */ __name((update, opts) => convertUpdateFormat(update, createObfuscator(opts), UpdateDecoderV1, UpdateEncoderV1), "obfuscateUpdate");
var obfuscateUpdateV2 = /* @__PURE__ */ __name((update, opts) => convertUpdateFormat(update, createObfuscator(opts), UpdateDecoderV2, UpdateEncoderV2), "obfuscateUpdateV2");
var convertUpdateFormatV1ToV2 = /* @__PURE__ */ __name((update) => convertUpdateFormat(update, id, UpdateDecoderV1, UpdateEncoderV2), "convertUpdateFormatV1ToV2");
...
var getTypeChildren = /* @__PURE__ */ __name((t) => {
  let s = t._start;
  const arr = [];
  while (s) {
    arr.push(s);
...
var typeListToArraySnapshot = /* @__PURE__ */ __name((type, snapshot2) => {
  const cs = [];
  let n = type._start;
  while (n !== null) {
...
var typeMapGetSnapshot = /* @__PURE__ */ __name((parent, key, snapshot2) => {
...
//# sourceMappingURL=chunk-2OJWYYAH.js.map
