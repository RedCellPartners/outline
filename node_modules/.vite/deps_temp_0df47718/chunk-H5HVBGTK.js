...
function createRenderStep(runNextFrame2) {
  ...
  var step = {
    schedule: /* @__PURE__ */ __name(function(callback, keepAlive, immediate) {
      if (keepAlive === void 0) {
        keepAlive = false;
      }
      if (immediate === void 0) {
    ...
    cancel: /* @__PURE__ */ __name(function(callback) {
      var index = toRunNextFrame.indexOf(callback);
      if (index !== -1)
        toRunNextFrame.splice(index, 1);
      toKeepAlive.delete(callback);
    }, "cancel"),
    process: /* @__PURE__ */ __name(function(frameData) {
      var _a;
      isProcessing2 = true;
...
var processStep = /* @__PURE__ */ __name(function(stepId) {
  return steps[stepId].process(frame);
}, "processStep");
var processFrame = /* @__PURE__ */ __name(function(timestamp) {
  runNextFrame = false;
...
var startLoop = /* @__PURE__ */ __name(function() {
  runNextFrame = true;
  useDefaultElapsed = true;
  if (!isProcessing) onNextFrame(processFrame);
}, "startLoop");
var getFrameData = /* @__PURE__ */ __name(function() {
  return frame;
}, "getFrameData");
var es_default = sync;
...
//# sourceMappingURL=chunk-H5HVBGTK.js.map
