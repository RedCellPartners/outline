...
__name(convertToMap, "convertToMap");
...
__name(addHiddenFinalProp, "addHiddenFinalProp");
function isPropertyConfigurable(object, prop) {
  var descriptor = Object.getOwnPropertyDescriptor(object, prop);
  return !descriptor || descriptor.configurable !== false && descriptor.writable !== false;
}
__name(isPropertyConfigurable, "isPropertyConfigurable");
...
__name(assertPropertyConfigurable, "assertPropertyConfigurable");
...
__name(createInstanceofPredicate, "createInstanceofPredicate");
function areBothNaN(a, b) {
  return typeof a === "number" && typeof b === "number" && isNaN(a) && isNaN(b);
}
__name(areBothNaN, "areBothNaN");
...
__name(isES6Map, "isES6Map");
function isES6Set(thing) {
  return thing instanceof Set;
}
__name(isES6Set, "isES6Set");
...
__name(primitiveSymbol, "primitiveSymbol");
...
__name(iteratorSymbol, "iteratorSymbol");
function declareIterator(prototType, iteratorFactory) {
  addHiddenFinalProp(prototType, iteratorSymbol(), iteratorFactory);
}
__name(declareIterator, "declareIterator");
...
__name(toStringTagSymbol, "toStringTagSymbol");
function getSelf() {
  return this;
}
...
__name(identityComparer, "identityComparer");
function structuralComparer(a, b) {
  return deepEqual(a, b);
}
__name(structuralComparer, "structuralComparer");
function shallowComparer(a, b) {
  return deepEqual(a, b, 1);
}
__name(shallowComparer, "shallowComparer");
function defaultComparer(a, b) {
  return areBothNaN(a, b) || identityComparer(a, b);
}
__name(defaultComparer, "defaultComparer");
var comparer = {
...
__name(createPropertyInitializerDescriptor, "createPropertyInitializerDescriptor");
...
function createPropDecorator(propertyInitiallyEnumerable, propertyCreator) {
  return /* @__PURE__ */ __name(function decoratorFactory() {
    var decoratorArguments;
    var decorator = /* @__PURE__ */ __name(function decorate2(target, prop, descriptor, applyImmediately) {
...
__name(createPropDecorator, "createPropDecorator");
function quacksLikeADecorator(args) {
  return (args.length === 2 || args.length === 3) && typeof args[1] === "string" || args.length === 4 && args[3] === true;
}
__name(quacksLikeADecorator, "quacksLikeADecorator");
...
__name(deepEnhancer, "deepEnhancer");
...
__name(shallowEnhancer, "shallowEnhancer");
...
__name(refStructEnhancer, "refStructEnhancer");
function createDecoratorForEnhancer(enhancer) {
  ...
  var res = (
    ...
    typeof process !== "undefined" && process.env && true ? /* @__PURE__ */ __name(function observableDecorator() {
...
__name(createDecoratorForEnhancer, "createDecoratorForEnhancer");
...
__name(assertValidOption, "assertValidOption");
...
__name(asCreateObservableOptions, "asCreateObservableOptions");
...
__name(getEnhancerFromOptions, "getEnhancerFromOptions");
...
var observableFactories = {
  box: /* @__PURE__ */ __name(function(value, options) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("box");
    var o = asCreateObservableOptions(options);
    return new ObservableValue(value, getEnhancerFromOptions(o), o.name, true, o.equals);
  }, "box"),
  shallowBox: /* @__PURE__ */ __name(function(value, name) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("shallowBox");
    deprecated("observable.shallowBox", "observable.box(value, { deep: false })");
    return observable.box(value, { name, deep: false });
  }, "shallowBox"),
  array: /* @__PURE__ */ __name(function(initialValues, options) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("array");
    var o = asCreateObservableOptions(options);
    return new ObservableArray(initialValues, getEnhancerFromOptions(o), o.name);
  }, "array"),
  shallowArray: /* @__PURE__ */ __name(function(initialValues, name) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("shallowArray");
    deprecated("observable.shallowArray", "observable.array(values, { deep: false })");
    return observable.array(initialValues, { name, deep: false });
  }, "shallowArray"),
  map: /* @__PURE__ */ __name(function(initialValues, options) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("map");
    var o = asCreateObservableOptions(options);
    return new ObservableMap(initialValues, getEnhancerFromOptions(o), o.name);
  }, "map"),
  shallowMap: /* @__PURE__ */ __name(function(initialValues, name) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("shallowMap");
    deprecated("observable.shallowMap", "observable.map(values, { deep: false })");
    return observable.map(initialValues, { name, deep: false });
  }, "shallowMap"),
  set: /* @__PURE__ */ __name(function(initialValues, options) {
    if (arguments.length > 2)
      incorrectlyUsedAsDecorator("set");
    var o = asCreateObservableOptions(options);
    return new ObservableSet(initialValues, getEnhancerFromOptions(o), o.name);
  }, "set"),
  object: /* @__PURE__ */ __name(function(props, decorators, options) {
    if (typeof arguments[1] === "string")
      incorrectlyUsedAsDecorator("object");
    var o = asCreateObservableOptions(options);
    return extendObservable({}, props, decorators, o);
  }, "object"),
  shallowObject: /* @__PURE__ */ __name(function(props, name) {
    if (typeof arguments[1] === "string")
...
__name(incorrectlyUsedAsDecorator, "incorrectlyUsedAsDecorator");
...
var computed = /* @__PURE__ */ __name(function computed2(arg1, arg2, arg3) {
...
var CaughtException = (
  ...
  /* @__PURE__ */ function() {
    ...
    __name(CaughtException2, "CaughtException");
...
__name(isCaughtException, "isCaughtException");
...
__name(isComputingDerivation, "isComputingDerivation");
...
__name(checkIfStateReadsAreAllowed, "checkIfStateReadsAreAllowed");
...
__name(warnAboutDerivationWithoutDependencies, "warnAboutDerivationWithoutDependencies");
...
__name(bindDependencies, "bindDependencies");
...
__name(clearObserving, "clearObserving");
...
__name(untrackedStart, "untrackedStart");
function untrackedEnd(prev) {
  globalState.trackingDerivation = prev;
}
__name(untrackedEnd, "untrackedEnd");
function allowStateReadsStart(allowStateReads) {
  var prev = globalState.allowStateReads;
  globalState.allowStateReads = allowStateReads;
  return prev;
}
__name(allowStateReadsStart, "allowStateReadsStart");
function allowStateReadsEnd(prev) {
  globalState.allowStateReads = prev;
}
__name(allowStateReadsEnd, "allowStateReadsEnd");
...
__name(changeDependenciesStateTo0, "changeDependenciesStateTo0");
...
function createAction(actionName, fn) {
  ...
  var res = /* @__PURE__ */ __name(function() {
...
__name(_startAction, "_startAction");
...
__name(allowStateChanges, "allowStateChanges");
function allowStateChangesStart(allowStateChanges2) {
  var prev = globalState.allowStateChanges;
  globalState.allowStateChanges = allowStateChanges2;
  return prev;
}
__name(allowStateChangesStart, "allowStateChangesStart");
function allowStateChangesEnd(prev) {
  globalState.allowStateChanges = prev;
}
__name(allowStateChangesEnd, "allowStateChangesEnd");
...
__name(allowStateChangesInsideComputed, "allowStateChangesInsideComputed");
var ObservableValue = (
  /** @class */
  function(_super) {
    ...
    __name(ObservableValue2, "ObservableValue");
...
var ComputedValue = (
  ...
  function() {
    ...
    __name(ComputedValue2, "ComputedValue");
...
var MobXGlobals = (
  ...
  /* @__PURE__ */ function() {
    ...
    __name(MobXGlobals2, "MobXGlobals");
    return MobXGlobals2;
  }()
);
...
__name(isolateGlobalState, "isolateGlobalState");
...
__name(getObservers, "getObservers");
...
__name(addObserver, "addObserver");
...
__name(removeObserver, "removeObserver");
...
__name(reportObserved, "reportObserved");
...
__name(propagateChanged, "propagateChanged");
...
__name(propagateChangeConfirmed, "propagateChangeConfirmed");
...
__name(propagateMaybeChanged, "propagateMaybeChanged");
...
__name(logTraceInfo, "logTraceInfo");
...
__name(printDepTree, "printDepTree");
var Reaction = (
  /** @class */
  function() {
...
__name(onReactionError, "onReactionError");
var MAX_REACTION_ITERATIONS = 100;
var reactionScheduler = /* @__PURE__ */ __name(function(f) {
  return f();
}, "reactionScheduler");
...
__name(runReactions, "runReactions");
...
function setReactionScheduler(fn) {
  ...
  reactionScheduler = /* @__PURE__ */ __name(function(f) {
    return fn(function() {
...
__name(spyReportStart, "spyReportStart");
...
__name(dontReassignFields, "dontReassignFields");
  ...
  return function(target, prop, descriptor) {
    if (descriptor) {
      ...
      return {
        ...
        configurable: true,
        writable: true,
        initializer: /* @__PURE__ */ __name(function() {
...
__name(namedActionDecorator, "namedActionDecorator");
...
__name(actionFieldDecorator, "actionFieldDecorator");
...
__name(boundActionDecorator, "boundActionDecorator");
var action = /* @__PURE__ */ __name(function action2(arg1, arg2, arg3, arg4) {
...
__name(runInAction, "runInAction");
...
__name(defineBoundAction, "defineBoundAction");
function autorun(view, opts) {
  ...
  __name(reactionRunner, "reactionRunner");
  reaction2.schedule();
  return reaction2.getDisposer();
}
__name(autorun, "autorun");
var run = /* @__PURE__ */ __name(function(f) {
  return f();
}, "run");
...
__name(createSchedulerFromOptions, "createSchedulerFromOptions");
...
__name(onBecomeObserved, "onBecomeObserved");
...
__name(interceptHook, "interceptHook");
...
__name(extendShallowObservable, "extendShallowObservable");
...
__name(extendObservable, "extendObservable");
function getDependencyTree(thing, property) {
  return nodeToDependencyTree(getAtom(thing, property));
}
__name(getDependencyTree, "getDependencyTree");
...
__name(nodeToDependencyTree, "nodeToDependencyTree");
function getObserverTree(thing, property) {
  return nodeToObserverTree(getAtom(thing, property));
}
__name(getObserverTree, "getObserverTree");
...
__name(nodeToObserverTree, "nodeToObserverTree");
var generatorId = 0;
function FlowCancellationError() {
  this.message = "FLOW_CANCELLED";
}
__name(FlowCancellationError, "FlowCancellationError");
FlowCancellationError.prototype = Object.create(Error.prototype);
function isFlowCancellationError(error) {
  return error instanceof FlowCancellationError;
}
__name(isFlowCancellationError, "isFlowCancellationError");
...
__name(interceptReads, "interceptReads");
...
__name(interceptInterceptable, "interceptInterceptable");
function interceptProperty(thing, property, handler) {
  return getAdministration(thing, property).intercept(handler);
}
__name(interceptProperty, "interceptProperty");
...
__name(_isComputed, "_isComputed");
...
__name(isComputedProp, "isComputedProp");
...
__name(isObservableProp, "isObservableProp");
function keys(obj) {
...
__name(observeObservable, "observeObservable");
function observeObservableProperty(thing, property, listener, fireImmediately) {
  return getAdministration(thing, property).observe(listener, fireImmediately);
}
__name(observeObservableProperty, "observeObservableProperty");
var defaultOptions = {
  detectCycles: true,
...
__name(getAtomFromArgs, "getAtomFromArgs");
...
__name(interceptChange, "interceptChange");
...
var ObservableArray = (
  ...
  function(_super) {
    ...
    __name(ObservableArray2, "ObservableArray");
...
Object.defineProperty(ObservableArray.prototype, "length", {
  ...
  set: /* @__PURE__ */ __name(function(newLength) {
...
__name(createArrayEntryDescriptor, "createArrayEntryDescriptor");
function createArrayBufferItem(index) {
  Object.defineProperty(ObservableArray.prototype, "" + index, createArrayEntryDescriptor(index));
}
__name(createArrayBufferItem, "createArrayBufferItem");
function reserveArrayBuffer(max) {
  for (var index = OBSERVABLE_ARRAY_BUFFER_SIZE; index < max; index++)
    createArrayBufferItem(index);
  OBSERVABLE_ARRAY_BUFFER_SIZE = max;
}
__name(reserveArrayBuffer, "reserveArrayBuffer");
reserveArrayBuffer(1e3);
var isObservableArrayAdministration = createInstanceofPredicate("ObservableArrayAdministration", ObservableArrayAdministration);
function isObservableArray(thing) {
  return isObject(thing) && isObservableArrayAdministration(thing.$mobx);
}
__name(isObservableArray, "isObservableArray");
...
var ObservableMap = (
  ...
  function() {
    ...
    __name(ObservableMap2, "ObservableMap");
...
var ObservableSet = (
  ...
  function() {
    ...
    __name(ObservableSet2, "ObservableSet");
...
var ObservableObjectAdministration = (
  ...
  function() {
    ...
    __name(ObservableObjectAdministration2, "ObservableObjectAdministration");
...
__name(asObservableObject, "asObservableObject");
...
__name(defineObservableProperty, "defineObservableProperty");
...
__name(defineComputedProperty, "defineComputedProperty");
...
__name(generateObservablePropConfig, "generateObservablePropConfig");
...
__name(getAdministrationForComputedPropOwner, "getAdministrationForComputedPropOwner");
...
__name(generateComputedPropConfig, "generateComputedPropConfig");
...
__name(notifyPropertyAddition, "notifyPropertyAddition");
...
__name(getAdministration, "getAdministration");
...
(function() {
  ...
  __name(testCodeMinification, "testCodeMinification");
...
mobx/lib/mobx.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-IHFIALTD.js.map
