    ...
    !function(e, t) {
      ...
      function l(e2, t2) {
        ...
        var o2, n2 = function(e3, t3) {
          if (null == e3) return {};
          for (var o3, n3 = {}, a3 = Object.keys(e3), r3 = 0; r3 < a3.length; r3++) o3 = a3[r3], 0 <= t3.indexOf(o3) || (n3[o3] = e3[o3]);
          return n3;
        }(e2, t2);
        if (Object.getOwnPropertySymbols) for (var a2 = Object.getOwnPropertySymbols(e2), r2 = 0; r2 < a2.length; r2++) o2 = a2[r2], 0 <= t2.indexOf(o2) || Object.prototype.propertyIsEnumerable.call(e2, o2) && (n2[o2] = e2[o2]);
        return n2;
      }
      __name(l, "l");
      function d(e2) {
      ...
      var b, w = !("undefined" == typeof window || "undefined" == typeof navigator || !("ontouchstart" in window || 0 < navigator.msMaxTouchPoints)), M = "undefined" != typeof File, O = { touch: { react: { down: "onTouchStart", mouseDown: "onMouseDown", drag: "onTouchMove", move: "onTouchMove", mouseMove: "onMouseMove", up: "onTouchEnd", mouseUp: "onMouseUp" }, native: { down: "touchstart", mouseDown: "mousedown", drag: "touchmove", move: "touchmove", mouseMove: "mousemove", up: "touchend", mouseUp: "mouseup" } }, desktop: { react: { down: "onMouseDown", drag: "onDragOver", move: "onMouseMove", up: "onMouseUp" }, native: { down: "mousedown", drag: "dragStart", move: "mousemove", up: "mouseup" } } }, I = w ? O.touch : O.desktop, P = "undefined" != typeof window && window.devicePixelRatio ? window.devicePixelRatio : 1, C = { x: 0.5, y: 0.5 }, x = function() {
        ...
        return e2 = a2, (t2 = [{ key: "componentDidMount", value: /* @__PURE__ */ __name(function() {
          ...
          this.props.image && this.loadImage(this.props.image), this.paint(o3), document && (e3 = !!function() {
            var t4 = false;
            try {
              var e4 = Object.defineProperty({}, "passive", { get: /* @__PURE__ */ __name(function() {
                t4 = true;
              }, "get") });
        ...
        }, "value") }, { key: "componentDidUpdate", value: /* @__PURE__ */ __name(function(e3, t3) {
        ...
        }, "value") }, { key: "componentWillUnmount", value: /* @__PURE__ */ __name(function() {
          var e3;
        ...
        }, "value") }, { key: "isVertical", value: /* @__PURE__ */ __name(function() {
          return !this.props.disableCanvasRotation && this.props.rotate % 180 != 0;
        }, "value") }, { key: "getBorders", value: /* @__PURE__ */ __name(function(e3) {
          var t3 = 0 < arguments.length && void 0 !== e3 ? e3 : this.props.border;
          return Array.isArray(t3) ? t3 : [t3, t3];
        }, "value") }, { key: "getDimensions", value: /* @__PURE__ */ __name(function() {
        ...
        }, "value") }, { key: "getImage", value: /* @__PURE__ */ __name(function() {
        ...
        }, "value") }, { key: "getImageScaledToCanvas", value: /* @__PURE__ */ __name(function() {
        ...
        }, "value") }, { key: "loadImage", value: /* @__PURE__ */ __name(function(e3) {
          var t3;
        ...
        }, "value") }, { key: "getInitialSize", value: /* @__PURE__ */ __name(function(e3, t3) {
        ...
        }, "value") }, { key: "paintImage", value: /* @__PURE__ */ __name(function(e3, t3, o3, n3) {
        ...
        }, "value") }, { key: "calculatePosition", value: /* @__PURE__ */ __name(function(e3, t3) {
        ...
        }, "value") }, { key: "paint", value: /* @__PURE__ */ __name(function(e3) {
        ...
        }, "value") }]) && r(e2.prototype, t2), o2 && r(e2, o2), a2;
      }();
      return s(x, "propTypes", { scale: n.default.number, rotate: n.default.number, image: n.default.oneOfType([n.default.string].concat(function(e2) {
        if (Array.isArray(e2)) return f(e2);
      ...
      }())), border: n.default.oneOfType([n.default.number, n.default.arrayOf(n.default.number)]), borderRadius: n.default.number, width: n.default.number, height: n.default.number, position: n.default.shape({ x: n.default.number, y: n.default.number }), color: n.default.arrayOf(n.default.number), backgroundColor: n.default.string, crossOrigin: n.default.oneOf(["", "anonymous", "use-credentials"]), onLoadFailure: n.default.func, onLoadSuccess: n.default.func, onImageReady: n.default.func, onImageChange: n.default.func, onMouseUp: n.default.func, onMouseMove: n.default.func, onPositionChange: n.default.func, disableBoundaryChecks: n.default.bool, disableHiDPIScaling: n.default.bool, disableCanvasRotation: n.default.bool }), s(x, "defaultProps", { scale: 1, rotate: 0, border: 25, borderRadius: 0, width: 200, height: 200, color: [0, 0, 0, 0.5], onLoadFailure: /* @__PURE__ */ __name(function() {
      }, "onLoadFailure"), onLoadSuccess: /* @__PURE__ */ __name(function() {
      }, "onLoadSuccess"), onImageReady: /* @__PURE__ */ __name(function() {
      }, "onImageReady"), onImageChange: /* @__PURE__ */ __name(function() {
      }, "onImageChange"), onMouseUp: /* @__PURE__ */ __name(function() {
      }, "onMouseUp"), onMouseMove: /* @__PURE__ */ __name(function() {
      }, "onMouseMove"), onPositionChange: /* @__PURE__ */ __name(function() {
      }, "onPositionChange"), disableBoundaryChecks: false, disableHiDPIScaling: false, disableCanvasRotation: true }), x;
    });
  }
});
