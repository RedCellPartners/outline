...
function createTippy(reference, passedProps) {
  ...
  function createPopperInstance() {
    ...
    var tippyModifier = {
      ...
      fn: /* @__PURE__ */ __name(function fn5(_ref2) {
...
var hideAll = /* @__PURE__ */ __name(function hideAll2(_temp) {
...
var createSingleton = /* @__PURE__ */ __name(function createSingleton2(tippyInstances, optionalProps) {
  ...
  setTriggerTargets();
  var plugin = {
    fn: /* @__PURE__ */ __name(function fn5() {
      return {
...
var animateFill = {
  ...
  fn: /* @__PURE__ */ __name(function fn(instance) {
    ...
    return {
      onCreate: /* @__PURE__ */ __name(function onCreate2() {
        if (backdrop) {
      ...
      onShow: /* @__PURE__ */ __name(function onShow2() {
        if (backdrop) {
...
__name(createBackdropElement, "createBackdropElement");
var mouseCoords = {
  clientX: 0,
  clientY: 0
};
...
var followCursor = {
  ...
  fn: /* @__PURE__ */ __name(function fn2(instance) {
    ...
    return {
      ...
      onAfterUpdate: /* @__PURE__ */ __name(function onAfterUpdate2(_, _ref2) {
...
var inlinePositioning = {
  ...
  defaultValue: false,
  fn: /* @__PURE__ */ __name(function fn3(instance) {
    var reference = instance.reference;
    function isEnabled() {
    ...
    __name(_getReferenceClientRect, "_getReferenceClientRect");
    function setInternalProps(partialProps) {
      isInternalUpdate = true;
      instance.setProps(partialProps);
      isInternalUpdate = false;
    }
    __name(setInternalProps, "setInternalProps");
    function addModifier() {
      if (!isInternalUpdate) {
        setInternalProps(getProps(instance.props, modifier));
      }
    }
    __name(addModifier, "addModifier");
    return {
...
__name(getInlineBoundingClientRect, "getInlineBoundingClientRect");
var sticky = {
  name: "sticky",
  defaultValue: false,
  fn: /* @__PURE__ */ __name(function fn4(instance) {
...
__name(areRectsDifferent, "areRectsDifferent");
...
//# sourceMappingURL=chunk-UQHNN6QW.js.map
