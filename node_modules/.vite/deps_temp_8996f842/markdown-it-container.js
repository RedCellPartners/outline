...
var require_markdown_it_container = __commonJS({
  "node_modules/markdown-it-container/index.js"(exports, module) {
    module.exports = /* @__PURE__ */ __name(function container_plugin(md, name, options) {
      function validateDefault(params) {
        return params.trim().split(" ", 2)[0] === name;
      }
      __name(validateDefault, "validateDefault");
...
export default require_markdown_it_container();
