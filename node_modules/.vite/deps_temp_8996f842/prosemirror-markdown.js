  ...
  return /* @__PURE__ */ __name(function decodeHTMLBinary(str, strict) {
    ...
    while ((strIdx = str.indexOf("&", strIdx)) >= 0) {
      ...
      if (str.charCodeAt(strIdx) === CharCodes.NUM) {
        ...
        if (start !== strIdx) {
          const entity2 = str.substring(start, strIdx);
          const parsed = parseInt(entity2, base2);
...
__name(smartquotes, "smartquotes");
...
__name(emphasis_tokenize, "emphasis_tokenize");
...
__name(emphasis_post_process, "emphasis_post_process");
...
__name(isLinkOpen2, "isLinkOpen");
function isLinkClose2(str) {
  return /^<\/a\s*>/i.test(str);
}
__name(isLinkClose2, "isLinkClose");
...
// node_modules/linkify-it/node_modules/uc.micro/properties/Any/regex.mjs
var regex_default6 = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;

// node_modules/linkify-it/node_modules/uc.micro/categories/Cc/regex.mjs
var regex_default7 = /[\0-\x1F\x7F-\x9F]/;

// node_modules/linkify-it/node_modules/uc.micro/categories/P/regex.mjs
var regex_default8 = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/;

// node_modules/linkify-it/node_modules/uc.micro/categories/Z/regex.mjs
var regex_default9 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/;

// node_modules/linkify-it/lib/re.mjs
function re_default(opts) {
  const re = {};
  opts = opts || {};
  re.src_Any = regex_default6.source;
  re.src_Cc = regex_default7.source;
  re.src_Z = regex_default9.source;
  re.src_P = regex_default8.source;
...
LinkifyIt.prototype.add = /* @__PURE__ */ __name(function add(schema2, definition) {
...
LinkifyIt.prototype.matchAtStart = /* @__PURE__ */ __name(function matchAtStart(text2) {
  this.__text_cache__ = text2;
  this.__index__ = -1;
...
LinkifyIt.prototype.normalize = /* @__PURE__ */ __name(function normalize2(match2) {
  if (!match2.schema) {
...
var schema = new Schema({
  nodes: {
    ...
    code_block: {
      ...
      parseDOM: [{ tag: "pre", preserveWhitespace: "full", getAttrs: /* @__PURE__ */ __name((node) => ({ params: node.getAttribute("data-params") || "" }), "getAttrs") }],
      toDOM(node) {
  ...
  marks: {
    em: {
      parseDOM: [
        ...
        { style: "font-style=normal", clearMark: /* @__PURE__ */ __name((m) => m.type.name == "em", "clearMark") }
      ],
      toDOM() {
        return ["em"];
      }
    ...
    strong: {
      parseDOM: [
        { tag: "strong" },
        { tag: "b", getAttrs: /* @__PURE__ */ __name((node) => node.style.fontWeight != "normal" && null, "getAttrs") },
        { style: "font-weight=400", clearMark: /* @__PURE__ */ __name((m) => m.type.name == "strong", "clearMark") },
        { style: "font-weight", getAttrs: /* @__PURE__ */ __name((value) => /^(bold(er)?|[5-9]\d{2,})$/.test(value) && null, "getAttrs") }
      ],
      toDOM() {
        return ["strong"];
      }
...
var _MarkdownParseState = class _MarkdownParseState {
...
__name(_MarkdownParseState, "MarkdownParseState");
var MarkdownParseState = _MarkdownParseState;
...
var _MarkdownParser = class _MarkdownParser {
  /**
...
var defaultMarkdownParser = new MarkdownParser(schema, lib_default("commonmark", { html: false }), {
  ...
  bullet_list: { block: "bullet_list", getAttrs: /* @__PURE__ */ __name((_, tokens, i) => ({ tight: listIsTight(tokens, i) }), "getAttrs") },
  ordered_list: { block: "ordered_list", getAttrs: /* @__PURE__ */ __name((tok, tokens, i) => ({
...
var _MarkdownSerializer = class _MarkdownSerializer {
  /**
...
__name(_MarkdownSerializer, "MarkdownSerializer");
var MarkdownSerializer = _MarkdownSerializer;
...
var _MarkdownSerializerState = class _MarkdownSerializerState {
  /**
  @internal
  */
  constructor(nodes, marks, options) {
  ...
  */
  renderInline(parent, fromBlockStart = true) {
    ...
    let active = [], trailing = "";
    let progress = /* @__PURE__ */ __name((node, offset, index) => {
...
__name(_MarkdownSerializerState, "MarkdownSerializerState");
var MarkdownSerializerState = _MarkdownSerializerState;
export {
  MarkdownParser,
  MarkdownSerializer,
