...
var DEL_ACROSS = 4;
var DEL_SIDE = 8;
var _MapResult = class _MapResult {
  /**
  @internal
  */
...
__name(_MapResult, "MapResult");
var MapResult = _MapResult;
var _StepMap = class _StepMap {
  /**
...
__name(_StepMap, "StepMap");
var StepMap = _StepMap;
StepMap.empty = new StepMap([]);
var _Mapping = class _Mapping {
  /**
...
__name(_Step, "Step");
var Step = _Step;
var _StepResult = class _StepResult {
  /**
  @internal
  */
...
__name(_StepResult, "StepResult");
var StepResult = _StepResult;
...
var _AddMarkStep = class _AddMarkStep extends Step {
  /**
  Create a mark step.
  */
...
__name(_AddMarkStep, "AddMarkStep");
var AddMarkStep = _AddMarkStep;
Step.jsonID("addMark", AddMarkStep);
var _RemoveMarkStep = class _RemoveMarkStep extends Step {
  /**
...
__name(_RemoveMarkStep, "RemoveMarkStep");
var RemoveMarkStep = _RemoveMarkStep;
Step.jsonID("removeMark", RemoveMarkStep);
var _AddNodeMarkStep = class _AddNodeMarkStep extends Step {
  /**
...
__name(_AddNodeMarkStep, "AddNodeMarkStep");
var AddNodeMarkStep = _AddNodeMarkStep;
Step.jsonID("addNodeMark", AddNodeMarkStep);
var _RemoveNodeMarkStep = class _RemoveNodeMarkStep extends Step {
  /**
  Create a mark-removing step.
  */
  constructor(pos, mark) {
...
__name(_RemoveNodeMarkStep, "RemoveNodeMarkStep");
var RemoveNodeMarkStep = _RemoveNodeMarkStep;
Step.jsonID("removeNodeMark", RemoveNodeMarkStep);
var _ReplaceStep = class _ReplaceStep extends Step {
  /**
...
__name(_ReplaceStep, "ReplaceStep");
var ReplaceStep = _ReplaceStep;
Step.jsonID("replace", ReplaceStep);
var _ReplaceAroundStep = class _ReplaceAroundStep extends Step {
  /**
...
__name(_ReplaceAroundStep, "ReplaceAroundStep");
var ReplaceAroundStep = _ReplaceAroundStep;
...
__name(clearIncompatible, "clearIncompatible");
function canCut(node, start, end) {
  return (start == 0 || node.canReplace(start, node.childCount)) && (end == node.childCount || node.canReplace(0, end));
}
__name(canCut, "canCut");
...
__name(findWrapping, "findWrapping");
function withAttrs(type) {
  return { type, attrs: null };
}
__name(withAttrs, "withAttrs");
...
__name(findWrappingOutside, "findWrappingOutside");
...
__name(findWrappingInside, "findWrappingInside");
...
__name(setBlockType, "setBlockType");
...
__name(fitsTrivially, "fitsTrivially");
var _Fitter = class _Fitter {
...
__name(dropFromFragment, "dropFromFragment");
function addToFragment(fragment, depth, content) {
  if (depth == 0)
    return fragment.append(content);
  return fragment.replaceChild(fragment.childCount - 1, fragment.lastChild.copy(addToFragment(fragment.lastChild.content, depth - 1, content)));
}
__name(addToFragment, "addToFragment");
function contentAt(fragment, depth) {
  for (let i = 0; i < depth; i++)
    fragment = fragment.firstChild.content;
  return fragment;
}
__name(contentAt, "contentAt");
...
__name(closeNodeStart, "closeNodeStart");
...
__name(contentAfterFits, "contentAfterFits");
...
__name(invalidMarks, "invalidMarks");
function definesContent(type) {
  return type.spec.defining || type.spec.definingForContent;
}
__name(definesContent, "definesContent");
...
__name(closeFragment, "closeFragment");
...
__name(replaceRangeWith, "replaceRangeWith");
...
__name(coveredDepths, "coveredDepths");
var _AttrStep = class _AttrStep extends Step {
  /**
...
__name(_AttrStep, "AttrStep");
var AttrStep = _AttrStep;
Step.jsonID("attr", AttrStep);
var _DocAttrStep = class _DocAttrStep extends Step {
  /**
  Construct an attribute step.
  */
...
__name(_DocAttrStep, "DocAttrStep");
var DocAttrStep = _DocAttrStep;
Step.jsonID("docAttr", DocAttrStep);
var _a;
var TransformError = (_a = class extends Error {
}, __name(_a, "TransformError"), _a);
...
//# sourceMappingURL=chunk-DIZBEZUH.js.map
