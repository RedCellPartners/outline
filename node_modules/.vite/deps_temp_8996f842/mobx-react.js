...
__name(observerBatching, "observerBatching");
...
__name(useStaticRendering, "useStaticRendering");
function isUsingStaticRendering() {
  return globalIsUsingStaticRendering;
}
__name(isUsingStaticRendering, "isUsingStaticRendering");
...
__name(printDebugValue, "printDebugValue");
...
__name(createTrackingData, "createTrackingData");
...
__name(ensureCleanupTimerRunning, "ensureCleanupTimerRunning");
function scheduleCleanupOfReactionIfLeaked(ref) {
  uncommittedReactionRefs.add(ref);
  ensureCleanupTimerRunning();
}
__name(scheduleCleanupOfReactionIfLeaked, "scheduleCleanupOfReactionIfLeaked");
function recordReactionAsCommitted(reactionRef) {
  uncommittedReactionRefs.delete(reactionRef);
}
__name(recordReactionAsCommitted, "recordReactionAsCommitted");
...
__name(cleanUncommittedReactions, "cleanUncommittedReactions");
...
__name(useQueuedForceUpdate, "useQueuedForceUpdate");
...
__name(useQueuedForceUpdateBlock, "useQueuedForceUpdateBlock");
...
__name(observerComponentNameFor, "observerComponentNameFor");
...
function observer(baseComponent, options) {
  ...
  var wrappedComponent = /* @__PURE__ */ __name(function(props, ref) {
...
__name(ObserverComponent, "ObserverComponent");
...
__name(ObserverPropsCheck, "ObserverPropsCheck");
...
__name(useAsObservableSourceInternal, "useAsObservableSourceInternal");
function useAsObservableSource(current) {
  return useAsObservableSourceInternal(current, false);
}
__name(useAsObservableSource, "useAsObservableSource");
...
__name(useLocalStore, "useLocalStore");
...
__name(wrapInTransaction, "wrapInTransaction");
...
__name(copyStaticProperties2, "copyStaticProperties");
...
__name(setHiddenProp, "setHiddenProp");
...
function wrapFunction(realMethod, mixins) {
  var fn = /* @__PURE__ */ __name(function fn2() {
...
function createDefinition(target, methodName, enumerable, mixins, originalMethod) {
  ...
  return _ref = {}, _ref[mobxPatchedDefinition] = true, _ref.get = /* @__PURE__ */ __name(function get() {
    return wrappedFunc;
  }, "get"), _ref.set = /* @__PURE__ */ __name(function set(value) {
    if (this === target) {
  ...
  }, "set"), _ref.configurable = true, _ref.enumerable = enumerable, _ref;
}
...
__name(makeClassComponentObserver, "makeClassComponentObserver");
...
function makeComponentReactive(render) {
  ...
  __name(reactiveRender, "reactiveRender");
  return reactiveRender.call(this);
}
__name(makeComponentReactive, "makeComponentReactive");
...
__name(makeObservableProp, "makeObservableProp");
...
function observer2(component) {
  ...
  if (ReactForwardRefSymbol && component["$$typeof"] === ReactForwardRefSymbol) {
    ...
    return (0, import_react8.forwardRef)(/* @__PURE__ */ __name(function ObserverForwardRef() {
      var args = arguments;
...
__name(createStoreInjector, "createStoreInjector");
...
__name(getInjectName, "getInjectName");
...
__name(grabStoresByName, "grabStoresByName");
function inject() {
...
__name(runDisposersOnWillUnmount, "runDisposersOnWillUnmount");
...
__name(disposeOnUnmount, "disposeOnUnmount");
...
__name(createObservableTypeCheckerCreator, "createObservableTypeCheckerCreator");
...
__name(createObservableArrayOfTypeChecker, "createObservableArrayOfTypeChecker");
