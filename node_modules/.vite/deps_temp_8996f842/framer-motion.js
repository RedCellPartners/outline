...
var createDefinition = /* @__PURE__ */ __name(function(propNames) {
  return {
    isEnabled: /* @__PURE__ */ __name(function(props) {
...
__name(useFeatures, "useFeatures");
...
var MotionConfigContext = (0, import_react3.createContext)({
  transformPagePoint: /* @__PURE__ */ __name(function(p) {
    return p;
  }, "transformPagePoint"),
  isStatic: false
});
...
function usePresence() {
  ...
  var safeToRemove = /* @__PURE__ */ __name(function() {
...
var counter = 0;
var incrementId = /* @__PURE__ */ __name(function() {
  return counter++;
}, "incrementId");
var useUniqueId = /* @__PURE__ */ __name(function() {
...
__name(isVariantLabels, "isVariantLabels");
...
__name(checkIfControllingVariants, "checkIfControllingVariants");
function checkIfVariantNode(props) {
  return Boolean(checkIfControllingVariants(props) || props.variants);
}
__name(checkIfVariantNode, "checkIfVariantNode");
...
function createMotionProxy(createConfig) {
  ...
  return new Proxy(custom, {
     ...
     */
    get: /* @__PURE__ */ __name(function(_target, key) {
...
__name(addScaleCorrection, "addScaleCorrection");
...
__name(sortTransformProps, "sortTransformProps");
var transformPropSet = new Set(transformProps);
function isTransformProp(key) {
  return transformPropSet.has(key);
}
__name(isTransformProp, "isTransformProp");
var transformOriginProps = /* @__PURE__ */ new Set(["originX", "originY", "originZ"]);
function isTransformOriginProp(key) {
  return transformOriginProps.has(key);
}
__name(isTransformOriginProp, "isTransformOriginProp");
...
var isMotionValue = /* @__PURE__ */ __name(function(value) {
...
__name(buildTransformOrigin, "buildTransformOrigin");
...
var getValueAsType = /* @__PURE__ */ __name(function(value, type) {
  return type && typeof value === "number" ? type.transform(value) : value;
}, "getValueAsType");

// node_modules/style-value-types/dist/es/utils.js
var clamp = /* @__PURE__ */ __name(function(min, max) {
  return function(v) {
    return Math.max(Math.min(v, max), min);
  };
}, "clamp");
var sanitize = /* @__PURE__ */ __name(function(v) {
...
var number = {
  test: /* @__PURE__ */ __name(function(v) {
    return typeof v === "number";
  }, "test"),
  parse: parseFloat,
  transform: /* @__PURE__ */ __name(function(v) {
    return v;
  }, "transform")
};
...
var createUnitType = /* @__PURE__ */ __name(function(unit) {
  return {
    test: /* @__PURE__ */ __name(function(v) {
...
var progressPercentage = __assign(__assign({}, percent), { parse: /* @__PURE__ */ __name(function(v) {
  return percent.parse(v) / 100;
}, "parse"), transform: /* @__PURE__ */ __name(function(v) {
  return percent.transform(v * 100);
}, "transform") });

// node_modules/style-value-types/dist/es/color/utils.js
var isColorString = /* @__PURE__ */ __name(function(type, testProp) {
  return function(v) {
    return Boolean(isString(v) && singleColorRegex.test(v) && v.startsWith(type) || testProp && Object.prototype.hasOwnProperty.call(v, testProp));
  };
}, "isColorString");
var splitColor = /* @__PURE__ */ __name(function(aName, bName, cName) {
  return function(v) {
    var _a;
    if (!isString(v))
      return v;
...
var hsla = {
  ...
  transform: /* @__PURE__ */ __name(function(_a) {
...
var rgbUnit = __assign(__assign({}, number), { transform: /* @__PURE__ */ __name(function(v) {
...
var color = {
  ...
  parse: /* @__PURE__ */ __name(function(v) {
    if (rgba.test(v)) {
      return rgba.parse(v);
    } else if (hsla.test(v)) {
      return hsla.parse(v);
...
var convertNumbersToZero = /* @__PURE__ */ __name(function(v) {
...
var filter = __assign(__assign({}, complex), { getAnimatableNone: /* @__PURE__ */ __name(function(v) {
...
var createHtmlRenderState = /* @__PURE__ */ __name(function() {
  return {
    style: {},
    transform: {},
    transformKeys: [],
...
var progressToPixels = /* @__PURE__ */ __name(function(progress2, length) {
...
var createSvgRenderState = /* @__PURE__ */ __name(function() {
...
function createUseRender(forwardMotionProps) {
  ...
  var useRender = /* @__PURE__ */ __name(function(Component3, props, ref, _a, isStatic) {
...
var camelToDash = /* @__PURE__ */ __name(function(str) {
...
var isKeyframesTarget = /* @__PURE__ */ __name(function(v) {
  return Array.isArray(v);
}, "isKeyframesTarget");

// node_modules/framer-motion/dist/es/utils/resolve-value.js
var isCustomValue = /* @__PURE__ */ __name(function(v) {
  return Boolean(v && typeof v === "object" && v.mix && v.toValue);
}, "isCustomValue");
var resolveFinalValueInKeyframes = /* @__PURE__ */ __name(function(v) {
...
var makeUseVisualState = /* @__PURE__ */ __name(function(config) {
...
var svgMotionConfig = {
  useVisualState: makeUseVisualState({
    ...
    onMount: /* @__PURE__ */ __name(function(props, instance, _a) {
...
function useFocusGesture(_a) {
  ...
  var onFocus = /* @__PURE__ */ __name(function() {
    var _a2;
...
var wrapHandler = /* @__PURE__ */ __name(function(handler, shouldFilterPrimaryPointer) {
...
var supportsPointerEvents = /* @__PURE__ */ __name(function() {
  return isBrowser && window.onpointerdown === null;
}, "supportsPointerEvents");
var supportsTouchEvents = /* @__PURE__ */ __name(function() {
  return isBrowser && window.ontouchstart === null;
}, "supportsTouchEvents");
var supportsMouseEvents = /* @__PURE__ */ __name(function() {
...
function createLock(name) {
  var lock = null;
  return function() {
    var openLock = /* @__PURE__ */ __name(function() {
      lock = null;
    }, "openLock");
    if (lock === null) {
      lock = name;
...
var isNodeOrChild = /* @__PURE__ */ __name(function(parent, child) {
  if (!child) {
    return false;
...
var clamp2 = /* @__PURE__ */ __name(function(min, max, v) {
...
function findSpring(_a) {
  ...
  if (dampingRatio < 1) {
    envelope = /* @__PURE__ */ __name(function(undampedFreq2) {
    ...
    derivative = /* @__PURE__ */ __name(function(undampedFreq2) {
      var exponentialDecay = undampedFreq2 * dampingRatio;
      var delta2 = exponentialDecay * duration;
...
function spring(_a) {
  ...
  function createSpring() {
    ...
    if (dampingRatio < 1) {
      ...
      resolveSpring = /* @__PURE__ */ __name(function(t) {
        var envelope = Math.exp(-dampingRatio * undampedAngularFreq * t);
        return to - envelope * ((initialVelocity + dampingRatio * undampedAngularFreq * initialDelta) / angularFreq_1 * Math.sin(angularFreq_1 * t) + initialDelta * Math.cos(angularFreq_1 * t));
      }, "resolveSpring");
      resolveVelocity = /* @__PURE__ */ __name(function(t) {
        var envelope = Math.exp(-dampingRatio * undampedAngularFreq * t);
  ...
  createSpring();
  return {
    next: /* @__PURE__ */ __name(function(t) {
    ...
    flipTarget: /* @__PURE__ */ __name(function() {
      var _a2;
      velocity = -velocity;
...
var zero = /* @__PURE__ */ __name(function(_t) {
  return 0;
}, "zero");

// node_modules/popmotion/dist/es/utils/progress.js
var progress = /* @__PURE__ */ __name(function(from, to, value) {
  var toFromDifference = to - from;
  return toFromDifference === 0 ? 1 : (value - from) / toFromDifference;
}, "progress");

// node_modules/popmotion/dist/es/utils/mix.js
var mix = /* @__PURE__ */ __name(function(from, to, progress2) {
  return -progress2 * from + progress2 * to + from;
}, "mix");

// node_modules/popmotion/dist/es/utils/mix-color.js
var mixLinearColor = /* @__PURE__ */ __name(function(from, to, v) {
  var fromExpo = from * from;
  var toExpo = to * to;
  return Math.sqrt(Math.max(0, v * (toExpo - fromExpo) + fromExpo));
}, "mixLinearColor");
var colorTypes = [hex, rgba, hsla];
var getColorType = /* @__PURE__ */ __name(function(v) {
  return colorTypes.find(function(type) {
    return type.test(v);
  });
}, "getColorType");
var notAnimatable = /* @__PURE__ */ __name(function(color2) {
  return "'" + color2 + "' is not an animatable color. Use the equivalent color code instead.";
}, "notAnimatable");
var mixColor = /* @__PURE__ */ __name(function(from, to) {
...
var isNum = /* @__PURE__ */ __name(function(v) {
  return typeof v === "number";
}, "isNum");

// node_modules/popmotion/dist/es/utils/pipe.js
var combineFunctions = /* @__PURE__ */ __name(function(a2, b2) {
  return function(v) {
    return b2(a2(v));
  };
}, "combineFunctions");
var pipe = /* @__PURE__ */ __name(function() {
  var transformers = [];
...
var mixArray = /* @__PURE__ */ __name(function(from, to) {
...
var mixObject = /* @__PURE__ */ __name(function(origin, target) {
...
var mixComplex = /* @__PURE__ */ __name(function(origin, target) {
...
var mixNumber = /* @__PURE__ */ __name(function(from, to) {
  return function(p) {
...
var reverseEasing = /* @__PURE__ */ __name(function(easing) {
  return function(p) {
    return 1 - easing(1 - p);
  };
}, "reverseEasing");
var mirrorEasing = /* @__PURE__ */ __name(function(easing) {
  return function(p) {
    return p <= 0.5 ? easing(2 * p) / 2 : (2 - easing(2 * (1 - p))) / 2;
  };
}, "mirrorEasing");
var createExpoIn = /* @__PURE__ */ __name(function(power) {
  return function(p) {
    return Math.pow(p, power);
  };
}, "createExpoIn");
var createBackIn = /* @__PURE__ */ __name(function(power) {
  return function(p) {
    return p * p * ((power + 1) * p - power);
  };
}, "createBackIn");
var createAnticipate = /* @__PURE__ */ __name(function(power) {
...
var linear = /* @__PURE__ */ __name(function(p) {
  return p;
}, "linear");
var easeIn = createExpoIn(2);
var easeOut = reverseEasing(easeIn);
var easeInOut = mirrorEasing(easeIn);
var circIn = /* @__PURE__ */ __name(function(p) {
...
var cb = 35442 / 1805;
var cc = 16061 / 1805;
var bounceOut = /* @__PURE__ */ __name(function(p) {
  if (p === 1 || p === 0)
    return p;
  var p2 = p * p;
...
var bounceInOut = /* @__PURE__ */ __name(function(p) {
...
var framesync = /* @__PURE__ */ __name(function(update) {
  var passTimestamp = /* @__PURE__ */ __name(function(_a) {
    var delta2 = _a.delta;
...
function inertia(_a) {
  ...
  function startAnimation2(options) {
    ...
    currentAnimation = animate(__assign(__assign({}, options), { driver, onUpdate: /* @__PURE__ */ __name(function(v) {
      var _a2;
  ...
  if (isOutOfBounds(from)) {
    ...
    var prev_1;
    var current_1;
    var checkBoundary = /* @__PURE__ */ __name(function(v) {
      prev_1 = current_1;
      current_1 = v;
...
var identity = /* @__PURE__ */ __name(function(v) {
  return v;
}, "identity");
var createAttractor = /* @__PURE__ */ __name(function(alterDisplacement) {
...
var isPoint = /* @__PURE__ */ __name(function(point) {
  return point.hasOwnProperty("x") && point.hasOwnProperty("y");
}, "isPoint");

// node_modules/popmotion/dist/es/utils/is-point-3d.js
var isPoint3D = /* @__PURE__ */ __name(function(point) {
  return isPoint(point) && point.hasOwnProperty("z");
}, "isPoint3D");

// node_modules/popmotion/dist/es/utils/distance.js
var distance1D = /* @__PURE__ */ __name(function(a2, b2) {
...
var wrap = /* @__PURE__ */ __name(function(min, max, v) {
  var rangeSize = max - min;
  return ((v - min) % rangeSize + rangeSize) % rangeSize + min;
}, "wrap");

// node_modules/popmotion/dist/es/easing/cubic-bezier.js
var a = /* @__PURE__ */ __name(function(a1, a2) {
  return 1 - 3 * a2 + 3 * a1;
}, "a");
var b = /* @__PURE__ */ __name(function(a1, a2) {
  return 3 * a2 - 6 * a1;
}, "b");
var c = /* @__PURE__ */ __name(function(a1) {
  return 3 * a1;
}, "c");
var calcBezier = /* @__PURE__ */ __name(function(t, a1, a2) {
  return ((a(a1, a2) * t + b(a1, a2)) * t + c(a1)) * t;
}, "calcBezier");
var getSlope = /* @__PURE__ */ __name(function(t, a1, a2) {
...
var makeRenderlessComponent = /* @__PURE__ */ __name(function(hook) {
...
var secondsToMilliseconds = /* @__PURE__ */ __name(function(seconds) {
  return seconds * 1e3;
...
var easingDefinitionToFunction = /* @__PURE__ */ __name(function(definition) {
...
var isEasingArray = /* @__PURE__ */ __name(function(ease) {
  return Array.isArray(ease) && typeof ease[0] !== "number";
}, "isEasingArray");

// node_modules/framer-motion/dist/es/animation/utils/is-animatable.js
var isAnimatable = /* @__PURE__ */ __name(function(key, value) {
  if (key === "zIndex")
    return false;
...
var underDampedSpring = /* @__PURE__ */ __name(function() {
  return {
    type: "spring",
    stiffness: 500,
    damping: 25,
...
var criticallyDampedSpring = /* @__PURE__ */ __name(function(to) {
  return {
    type: "spring",
    stiffness: 550,
...
var linearTween = /* @__PURE__ */ __name(function() {
  return {
    type: "keyframes",
    ease: "linear",
    duration: 0.3
...
var keyframes2 = /* @__PURE__ */ __name(function(values) {
  return {
    type: "keyframes",
    duration: 0.8,
    values
...
var getDefaultTransition = /* @__PURE__ */ __name(function(valueKey, to) {
...
var getDefaultValueType = /* @__PURE__ */ __name(function(key) {
...
function getAnimation(key, value, target, transition, onComplete) {
  ...
  function start() {
    var options = {
      ...
      onComplete,
      onUpdate: /* @__PURE__ */ __name(function(v) {
        return value.set(v);
      }, "onUpdate")
    };
    return valueTransition.type === "inertia" || valueTransition.type === "decay" ? inertia(__assign(__assign({}, options), valueTransition)) : animate(__assign(__assign({}, getPopmotionAnimationOptions(valueTransition, options, key)), { onUpdate: /* @__PURE__ */ __name(function(v) {
      var _a2;
      options.onUpdate(v);
      (_a2 = valueTransition.onUpdate) === null || _a2 === void 0 ? void 0 : _a2.call(valueTransition, v);
    }, "onUpdate"), onComplete: /* @__PURE__ */ __name(function() {
      var _a2;
      options.onComplete();
  ...
  function set() {
    ...
    return { stop: /* @__PURE__ */ __name(function() {
    }, "stop") };
  }
  __name(set, "set");
...
function startAnimation(key, value, target, transition) {
  ...
  return value.start(function(onComplete) {
    ...
    var start = /* @__PURE__ */ __name(function() {
...
var isNumericalString = /* @__PURE__ */ __name(function(v) {
  return /^\-?\d*\.?\d+$/.test(v);
}, "isNumericalString");
...
var SubscriptionManager = (
  ...
  function() {
    ...
    __name(SubscriptionManager2, "SubscriptionManager");
...
var isFloat = /* @__PURE__ */ __name(function(value) {
...
var testValueType = /* @__PURE__ */ __name(function(v) {
...
var findDimensionValueType = /* @__PURE__ */ __name(function(v) {
  return dimensionValueTypes.find(testValueType(v));
}, "findDimensionValueType");

// node_modules/framer-motion/dist/es/render/dom/value-types/find.js
var valueTypes = __spreadArray(__spreadArray([], __read(dimensionValueTypes)), [color, complex]);
var findValueType = /* @__PURE__ */ __name(function(v) {
...
function createAnimationState(visualElement2) {
  ...
  var buildResolvedTypeValues = /* @__PURE__ */ __name(function(acc, definition) {
    var resolved = resolveVariant(visualElement2, definition);
    if (resolved) {
      resolved.transition;
  ...
  function animateChanges(options, changedActiveType) {
    ...
    var _loop_1 = /* @__PURE__ */ __name(function(i2) {
      ...
      var markToAnimate = /* @__PURE__ */ __name(function(key2) {
...
__name(variantsHaveChanged, "variantsHaveChanged");
...
__name(convertBoundingBoxToAxisBox, "convertBoundingBoxToAxisBox");
...
__name(convertAxisBoxToBoundingBox, "convertAxisBoxToBoundingBox");
...
__name(transformBoundingBox, "transformBoundingBox");
function axisBox() {
  return { x: { min: 0, max: 1 }, y: { min: 0, max: 1 } };
}
__name(axisBox, "axisBox");
...
__name(copyAxisBox, "copyAxisBox");
var zeroDelta = {
  translate: 0,
  scale: 1,
  origin: 0,
...
__name(calcConstrainedMinPoint, "calcConstrainedMinPoint");
...
__name(calcPositionFromProgress, "calcPositionFromProgress");
...
var clampProgress = /* @__PURE__ */ __name(function(v) {
  return clamp2(0, 1, v);
}, "clampProgress");
...
__name(updateAxisDelta, "updateAxisDelta");
...
__name(updateBoxDelta, "updateBoxDelta");
function defaultOrigin(origin) {
  return typeof origin === "number" ? origin : 0.5;
}
__name(defaultOrigin, "defaultOrigin");
...
var compareByDepth = /* @__PURE__ */ __name(function(a2, b2) {
...
__name(isProjecting, "isProjecting");
...
__name(collectProjectingAncestors, "collectProjectingAncestors");
function collectProjectingChildren(visualElement2) {
  var children = [];
  var addChild = /* @__PURE__ */ __name(function(child) {
...
__name(collectProjectingChildren, "collectProjectingChildren");
...
__name(updateLayoutMeasurement, "updateLayoutMeasurement");
...
__name(snapshotViewportBox, "snapshotViewportBox");
...
__name(calcRelativeOffsetAxis, "calcRelativeOffsetAxis");
...
__name(calcRelativeOffset, "calcRelativeOffset");
function checkIfParentHasChanged(prev, next) {
  var prevId = prev.getLayoutId();
  var nextId = next.getLayoutId();
  return prevId !== nextId || nextId === void 0 && prev !== next;
}
__name(checkIfParentHasChanged, "checkIfParentHasChanged");
...
__name(resetAxis, "resetAxis");
function resetBox(box, originBox) {
  resetAxis(box.x, originBox.x);
  resetAxis(box.y, originBox.y);
}
__name(resetBox, "resetBox");
...
__name(applyAxisTransforms, "applyAxisTransforms");
...
__name(applyBoxTransforms, "applyBoxTransforms");
...
__name(convertToRelativeProjection, "convertToRelativeProjection");
...
__name(batchLayout, "batchLayout");
function flushLayout() {
  ...
  var reads = [[]];
  var writes = [];
  var setRead = /* @__PURE__ */ __name(function(job) {
    return pushJob(reads, job, pointer);
  }, "setRead");
  var setWrite = /* @__PURE__ */ __name(function(job) {
...
var executeJob = /* @__PURE__ */ __name(function(job) {
  return job();
}, "executeJob");
...
var VisualElementDragControls = (
  ...
  function() {
    ...
    __name(VisualElementDragControls2, "VisualElementDragControls");
    VisualElementDragControls2.prototype.start = function(originEvent, _a) {
      var _this = this;
      var _b = _a === void 0 ? {} : _a, _c = _b.snapToCursor, snapToCursor = _c === void 0 ? false : _c, cursorProgress = _b.cursorProgress;
      var onSessionStart = /* @__PURE__ */ __name(function(event) {
        var _a2;
        _this.stopMotion();
      ...
      var onStart = /* @__PURE__ */ __name(function(event, info) {
        var _a2, _b2, _c2;
      ...
      var onMove = /* @__PURE__ */ __name(function(event, info) {
        var _a2, _b2, _c2, _d;
      ...
      var onSessionEnd = /* @__PURE__ */ __name(function(event, info) {
...
function usePanGesture(_a) {
  ...
  var handlers = {
    ...
    onStart: onPanStart,
    onMove: onPan,
    onEnd: /* @__PURE__ */ __name(function(event, info) {
...
__name(correctBorderRadius, "correctBorderRadius");
var varToken = "_$css";
...
__name(correctBoxShadow, "correctBoxShadow");
...
var Animate = (
  ...
  function(_super) {
    ...
    Animate2.prototype.animateAxis = function(axis, target, origin, _a) {
      ...
      layoutProgress.set(0);
      var frame = /* @__PURE__ */ __name(function() {
...
__name(isProvidedCorrectDataForRelativeSharedLayout, "isProvidedCorrectDataForRelativeSharedLayout");
...
var defaultHandler = {
  layoutReady: /* @__PURE__ */ __name(function(child) {
...
function createBatcher() {
  ...
  return {
    add: /* @__PURE__ */ __name(function(child) {
      return queue.add(child);
    }, "add"),
    flush: /* @__PURE__ */ __name(function(_a) {
...
__name(createBatcher, "createBatcher");
function assignProjectionToSnapshot(child) {
  child.prevViewportBox = child.projection.target;
}
__name(assignProjectionToSnapshot, "assignProjectionToSnapshot");
...
__name(isSharedLayout, "isSharedLayout");
...
__name(MeasureContextProvider, "MeasureContextProvider");
...
var createProjectionState = /* @__PURE__ */ __name(function() {
  return {
    isEnabled: false,
    isHydrated: false,
...
__name(createLayoutState, "createLayoutState");
...
__name(buildLayoutProjectionTransform, "buildLayoutProjectionTransform");
function buildLayoutProjectionTransformOrigin(_a) {
  var deltaFinal = _a.deltaFinal;
  return deltaFinal.x.origin * 100 + "% " + deltaFinal.y.origin * 100 + "% 0";
}
__name(buildLayoutProjectionTransformOrigin, "buildLayoutProjectionTransformOrigin");
...
function createLifecycles() {
  ...
  var lifecycles = {
    clearAllListeners: /* @__PURE__ */ __name(function() {
      return managers.forEach(function(manager) {
        return manager.clear();
      });
    }, "clearAllListeners"),
    updatePropListeners: /* @__PURE__ */ __name(function(props) {
...
__name(updateLayoutDeltas, "updateLayoutDeltas");
...
__name(setCurrentViewportBox, "setCurrentViewportBox");

// node_modules/framer-motion/dist/es/render/index.js
var visualElement = /* @__PURE__ */ __name(function(_a) {
  ...
  return function(_a2, options) {
    ...
    __name(updateLayoutProjection, "updateLayoutProjection");
    function updateTreeLayoutProjection() {
      element.layoutTree.forEach(fireUpdateLayoutProjection);
    }
    __name(updateTreeLayoutProjection, "updateTreeLayoutProjection");
    ...
    var element = __assign(__assign({
      ...
      mount: /* @__PURE__ */ __name(function(newInstance) {
       ...
       *
       */
      unmount: /* @__PURE__ */ __name(function() {
       ...
       */
      addVariantChild: /* @__PURE__ */ __name(function(child) {
        var _a3;
      ...
      sortNodePosition: /* @__PURE__ */ __name(function(other) {
       ...
       * this visual element.
       */
      getClosestVariantNode: /* @__PURE__ */ __name(function() {
       ...
       */
      getLayoutId: /* @__PURE__ */ __name(function() {
        return props.layoutId;
      }, "getLayoutId"),
      /**
       * Returns the current instance.
       */
      getInstance: /* @__PURE__ */ __name(function() {
        return instance;
      }, "getInstance"),
      /**
       * Get/set the latest static values.
       */
      getStaticValue: /* @__PURE__ */ __name(function(key2) {
        return latestValues[key2];
      }, "getStaticValue"),
      setStaticValue: /* @__PURE__ */ __name(function(key2, value2) {
       ...
       * visual state
       */
      getLatestValues: /* @__PURE__ */ __name(function() {
        return latestValues;
      }, "getLatestValues"),
      /**
       ...
       */
      setVisibility: /* @__PURE__ */ __name(function(visibility) {
       ...
       * and CSS variables.
       */
      makeTargetAnimatable: /* @__PURE__ */ __name(function(target, canMutate) {
        if (canMutate === void 0) {
          canMutate = true;
        }
       ...
       */
      addValue: /* @__PURE__ */ __name(function(key2, value2) {
       ...
       */
      removeValue: /* @__PURE__ */ __name(function(key2) {
        var _a3;
        values.delete(key2);
       ...
       */
      hasValue: /* @__PURE__ */ __name(function(key2) {
       ...
       */
      getValue: /* @__PURE__ */ __name(function(key2, defaultValue) {
       ...
       */
      forEachValue: /* @__PURE__ */ __name(function(callback) {
       ...
       */
      readValue: /* @__PURE__ */ __name(function(key2) {
        var _a3;
       ...
       */
      setBaseTarget: /* @__PURE__ */ __name(function(key2, value2) {
       ...
       * props.
       */
      getBaseTarget: /* @__PURE__ */ __name(function(key2) {
        if (getBaseTarget) {
       ...
       */
      build: /* @__PURE__ */ __name(function() {
        triggerBuild();
        return renderState;
      }, "build"),
      /**
       ...
       */
      scheduleRender: /* @__PURE__ */ __name(function() {
       ...
       */
      getVariant: /* @__PURE__ */ __name(function(name) {
        var _a3;
       ...
       */
      getDefaultTransition: /* @__PURE__ */ __name(function() {
        return props.transition;
      }, "getDefaultTransition"),
      /**
       * Used by child variant nodes to get the closest ancestor variant props.
       */
      getVariantContext: /* @__PURE__ */ __name(function(startAtParent) {
       ...
       */
      enableLayoutProjection: /* @__PURE__ */ __name(function() {
       ...
       */
      lockProjectionTarget: /* @__PURE__ */ __name(function() {
        projection.isTargetLocked = true;
      }, "lockProjectionTarget"),
      unlockProjectionTarget: /* @__PURE__ */ __name(function() {
        element.stopLayoutAnimation();
        projection.isTargetLocked = false;
      }, "unlockProjectionTarget"),
      getLayoutState: /* @__PURE__ */ __name(function() {
        return layoutState;
      }, "getLayoutState"),
      setCrossfader: /* @__PURE__ */ __name(function(newCrossfader) {
        crossfader = newCrossfader;
      }, "setCrossfader"),
      isProjectionReady: /* @__PURE__ */ __name(function() {
        return projection.isEnabled && projection.isHydrated && layoutState.isHydrated;
      }, "isProjectionReady"),
      /**
       * Start a layout animation on a given axis.
       */
      startLayoutAnimation: /* @__PURE__ */ __name(function(axis, transition, isRelative) {
       ...
       */
      stopLayoutAnimation: /* @__PURE__ */ __name(function() {
        eachAxis(function(axis) {
       ...
       */
      measureViewportBox: /* @__PURE__ */ __name(function(withTransform) {
       ...
       */
      getProjectionAnimationProgress: /* @__PURE__ */ __name(function() {
       ...
       */
      setProjectionTargetAxis: /* @__PURE__ */ __name(function(axis, min, max, isRelative) {
        if (isRelative === void 0) {
          isRelative = false;
        }
        var target;
       ...
       */
      rebaseProjectionTarget: /* @__PURE__ */ __name(function(force, box) {
        if (box === void 0) {
       ...
       */
      notifyLayoutReady: /* @__PURE__ */ __name(function(config) {
      ...
      resolveRelativeTargetBox: /* @__PURE__ */ __name(function() {
      ...
      shouldResetTransform: /* @__PURE__ */ __name(function() {
        return Boolean(props._layoutResetTransform);
      }, "shouldResetTransform"),
      /**
       *
       */
      pointTo: /* @__PURE__ */ __name(function(newLead) {
...
__name(fireResolveRelativeTargetBox, "fireResolveRelativeTargetBox");
function fireUpdateLayoutProjection(child) {
  child.updateLayoutProjection();
}
__name(fireUpdateLayoutProjection, "fireUpdateLayoutProjection");
...
var isPositionalKey = /* @__PURE__ */ __name(function(key) {
  return positionalKeys.has(key);
}, "isPositionalKey");
var hasPositionalKey = /* @__PURE__ */ __name(function(target) {
  return Object.keys(target).some(isPositionalKey);
}, "hasPositionalKey");
var setAndResetVelocity = /* @__PURE__ */ __name(function(value, to) {
  value.set(to, false);
  value.set(to);
}, "setAndResetVelocity");
var isNumOrPxType = /* @__PURE__ */ __name(function(v) {
...
var getPosFromMatrix = /* @__PURE__ */ __name(function(matrix, pos) {
  return parseFloat(matrix.split(", ")[pos]);
}, "getPosFromMatrix");
var getTranslateFromMatrix = /* @__PURE__ */ __name(function(pos2, pos3) {
...
var positionalValues = {
  // Dimensions
  width: /* @__PURE__ */ __name(function(_a) {
    var x = _a.x;
    return x.max - x.min;
  }, "width"),
  height: /* @__PURE__ */ __name(function(_a) {
    var y = _a.y;
    return y.max - y.min;
  }, "height"),
  top: /* @__PURE__ */ __name(function(_bbox, _a) {
    var top = _a.top;
    return parseFloat(top);
  }, "top"),
  left: /* @__PURE__ */ __name(function(_bbox, _a) {
    var left = _a.left;
    return parseFloat(left);
  }, "left"),
  bottom: /* @__PURE__ */ __name(function(_a, _b) {
    var y = _a.y;
    var top = _b.top;
    return parseFloat(top) + (y.max - y.min);
  }, "bottom"),
  right: /* @__PURE__ */ __name(function(_a, _b) {
    var x = _a.x;
    var left = _b.left;
...
var convertChangedValueTypes = /* @__PURE__ */ __name(function(target, visualElement2, changedKeys) {
...
var checkAndConvertChangedValueTypes = /* @__PURE__ */ __name(function(visualElement2, target, origin, transitionEnd) {
  if (origin === void 0) {
    origin = {};
  }
...
var parseDomVariant = /* @__PURE__ */ __name(function(visualElement2, target, origin, transitionEnd) {
...
var htmlConfig = {
  treeType: "dom",
  readValueFromInstance: /* @__PURE__ */ __name(function(domElement, key) {
    if (isTransformProp(key)) {
  ...
  sortNodePosition: /* @__PURE__ */ __name(function(a2, b2) {
    return a2.compareDocumentPosition(b2) & 2 ? 1 : -1;
  }, "sortNodePosition"),
  getBaseTarget: /* @__PURE__ */ __name(function(props, key) {
    var _a;
    return (_a = props.style) === null || _a === void 0 ? void 0 : _a[key];
  }, "getBaseTarget"),
  measureViewportBox: /* @__PURE__ */ __name(function(element, _a) {
   ...
   * works
   */
  resetTransform: /* @__PURE__ */ __name(function(element, domElement, props) {
    var transformTemplate = props.transformTemplate;
    domElement.style.transform = transformTemplate ? transformTemplate({}, "") : "none";
    element.scheduleRender();
  }, "resetTransform"),
  restoreTransform: /* @__PURE__ */ __name(function(instance, mutableState) {
    instance.style.transform = mutableState.style.transform;
  }, "restoreTransform"),
  removeValueFromRenderState: /* @__PURE__ */ __name(function(key, _a) {
   ...
   */
  makeTargetAnimatable: /* @__PURE__ */ __name(function(element, _a, _b, isMounted) {
  ...
  scrapeMotionValuesFromProps,
  build: /* @__PURE__ */ __name(function(element, renderState, latestValues, projection, layoutState, options, props) {
...
var svgVisualElement = visualElement(__assign(__assign({}, htmlConfig), {
  ...
  scrapeMotionValuesFromProps: scrapeMotionValuesFromProps2,
  build: /* @__PURE__ */ __name(function(_element, renderState, latestValues, projection, layoutState, options, props) {
    var isProjectionTranform = projection.isEnabled && layoutState.isHydrated;
...
var createDomVisualElement = /* @__PURE__ */ __name(function(Component3, options) {
...
__name(getPresenceId, "getPresenceId");
var PresenceChild = /* @__PURE__ */ __name(function(_a) {
  ...
  var context = (0, import_react27.useMemo)(
    function() {
      return {
        ...
        custom,
        onExitComplete: /* @__PURE__ */ __name(function(childId) {
        ...
        register: /* @__PURE__ */ __name(function(childId) {
...
__name(getChildKey, "getChildKey");
...
var AnimatePresence = /* @__PURE__ */ __name(function(_a) {
  ...
  exiting.forEach(function(key2) {
    ...
    var onExit = /* @__PURE__ */ __name(function() {
...
function createCrossfader() {
  ...
  function startCrossfadeAnimation(target, transition) {
    ...
    var onUpdate = /* @__PURE__ */ __name(function() {
      hasUpdated = true;
    ...
    return animate2(progress2, target, __assign(__assign({}, transition), { onUpdate, onComplete: /* @__PURE__ */ __name(function() {
      if (!hasUpdated) {
  ...
  __name(startCrossfadeAnimation, "startCrossfadeAnimation");
  ...
  __name(updateCrossfade, "updateCrossfade");
  return {
    isActive: /* @__PURE__ */ __name(function() {
      return leadState && (isActive || getFrameData().timestamp === finalCrossfadeFrame);
    }, "isActive"),
    fromLead: /* @__PURE__ */ __name(function(transition) {
      return startCrossfadeAnimation(0, transition);
    }, "fromLead"),
    toLead: /* @__PURE__ */ __name(function(transition) {
    ...
    getCrossfadeState: /* @__PURE__ */ __name(function(element) {
      updateCrossfade();
    ...
    setOptions: /* @__PURE__ */ __name(function(newOptions) {
      prevOptions = options;
      options = newOptions;
      leadState = {};
      followState = {};
...
__name(createCrossfader, "createCrossfader");
...
function layoutStack() {
  ...
  __name(getFollowViewportBox, "getFollowViewportBox");
  function getFollowLayout() {
    var _a;
    return (_a = state.follow) === null || _a === void 0 ? void 0 : _a.getLayoutState().layout;
  }
  __name(getFollowLayout, "getFollowLayout");
  return {
    add: /* @__PURE__ */ __name(function(element) {
    ...
    remove: /* @__PURE__ */ __name(function(element) {
      stack.delete(element);
    }, "remove"),
    getLead: /* @__PURE__ */ __name(function() {
      return state.lead;
    }, "getLead"),
    updateSnapshot: /* @__PURE__ */ __name(function() {
      if (!state.lead)
        return;
    ...
    clearSnapshot: /* @__PURE__ */ __name(function() {
      prevDragCursor = prevViewportBox = void 0;
    }, "clearSnapshot"),
    updateLeadAndFollow: /* @__PURE__ */ __name(function() {
      var _a;
    ...
    animate: /* @__PURE__ */ __name(function(child, shouldCrossfade) {
      var _a;
...
__name(layoutStack, "layoutStack");
...
__name(resetRotate, "resetRotate");
...
var AnimateSharedLayout = (
  ...
  function(_super) {
    ...
    function AnimateSharedLayout2() {
      ...
      _this.syncContext = __assign(__assign({}, createBatcher()), { syncUpdate: /* @__PURE__ */ __name(function(force) {
        return _this.scheduleUpdate(force);
      }, "syncUpdate"), forceUpdate: /* @__PURE__ */ __name(function() {
        _this.syncContext = __assign({}, _this.syncContext);
        _this.scheduleUpdate(true);
      }, "forceUpdate"), register: /* @__PURE__ */ __name(function(child) {
        return _this.addChild(child);
      }, "register"), remove: /* @__PURE__ */ __name(function(child) {
        return _this.removeChild(child);
      }, "remove") });
      return _this;
    }
    __name(AnimateSharedLayout2, "AnimateSharedLayout");
...
function useCombineMotionValues(values, combineValues) {
  ...
  var updateValue = /* @__PURE__ */ __name(function() {
...
var isCustomValueType = /* @__PURE__ */ __name(function(v) {
  return typeof v === "object" && v.mix;
}, "isCustomValueType");
var getMixer2 = /* @__PURE__ */ __name(function(v) {
...
__name(createScrollMotionValues, "createScrollMotionValues");
function setProgress(offset, maxOffset, value) {
  value.set(!offset || !maxOffset ? 0 : offset / maxOffset);
}
__name(setProgress, "setProgress");
function createScrollUpdater(values, getOffsets) {
  var update = /* @__PURE__ */ __name(function() {
...
__name(createScrollUpdater, "createScrollUpdater");

// node_modules/framer-motion/dist/es/value/scroll/use-element-scroll.js
var getElementScrollOffsets = /* @__PURE__ */ __name(function(element) {
  return function() {
    return {
...
__name(getViewportScrollOffsets, "getViewportScrollOffsets");
...
function initPrefersReducedMotion() {
  ...
  if (window.matchMedia) {
    ...
    var setReducedMotionPreferences = /* @__PURE__ */ __name(function() {
...
function animationControls() {
  ...
  var controls = {
    subscribe: /* @__PURE__ */ __name(function(visualElement2) {
      subscribers.add(visualElement2);
      return function() {
        return void subscribers.delete(visualElement2);
      };
    }, "subscribe"),
    start: /* @__PURE__ */ __name(function(definition, transitionOverride) {
      if (hasMounted) {
        var animations_1 = [];
    ...
    set: /* @__PURE__ */ __name(function(definition) {
...
var createDragControls = /* @__PURE__ */ __name(function() {
...
var createObject = /* @__PURE__ */ __name(function() {
  return {};
}, "createObject");
var stateVisualElement = visualElement({
  ...
  removeValueFromRenderState: /* @__PURE__ */ __name(function() {
  }, "removeValueFromRenderState"),
  render: /* @__PURE__ */ __name(function() {
  }, "render"),
  scrapeMotionValuesFromProps: createObject,
  readValueFromInstance: /* @__PURE__ */ __name(function(_state, key, options) {
    return options.initialState[key] || 0;
  }, "readValueFromInstance"),
  makeTargetAnimatable: /* @__PURE__ */ __name(function(element, _a) {
    var transition = _a.transition, transitionEnd = _a.transitionEnd, target = __rest(_a, ["transition", "transitionEnd"]);
    var origin = getOrigin(target, transition || {}, element);
    checkTargetForNewValues(element, target, origin);
...
var maxScale = 1e5;
var invertScale = /* @__PURE__ */ __name(function(scale2) {
