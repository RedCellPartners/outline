...
var formatters = {
  // Era
  G: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // Year
  y: /* @__PURE__ */ __name(function(date, token, localize) {
    if (token === "yo") {
      const signedYear = date.getFullYear();
      const year = signedYear > 0 ? signedYear : 1 - signedYear;
  ...
  Y: /* @__PURE__ */ __name(function(date, token, localize, options) {
  ...
  // Quarter
  Q: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // Month
  M: /* @__PURE__ */ __name(function(date, token, localize) {
    const month = date.getMonth();
    switch (token) {
      case "M":
      case "MM":
  ...
  // Stand-alone month
  L: /* @__PURE__ */ __name(function(date, token, localize) {
    const month = date.getMonth();
    switch (token) {
      case "L":
  ...
  // Local week of year
  w: /* @__PURE__ */ __name(function(date, token, localize, options) {
  ...
  // ISO week of year
  I: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // Day of the month
  d: /* @__PURE__ */ __name(function(date, token, localize) {
    if (token === "do") {
  ...
  // Day of week
  E: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // Local day of week
  e: /* @__PURE__ */ __name(function(date, token, localize, options) {
    const dayOfWeek = date.getDay();
  ...
  c: /* @__PURE__ */ __name(function(date, token, localize, options) {
    const dayOfWeek = date.getDay();
    const localDayOfWeek = (dayOfWeek - options.weekStartsOn + 8) % 7 || 7;
    switch (token) {
      case "c":
  ...
  // AM or PM
  a: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // AM, PM, midnight, noon
  b: /* @__PURE__ */ __name(function(date, token, localize) {
    const hours = date.getHours();
  ...
  // Hour [1-12]
  h: /* @__PURE__ */ __name(function(date, token, localize) {
    if (token === "ho") {
  ...
  // Hour [0-11]
  K: /* @__PURE__ */ __name(function(date, token, localize) {
  ...
  // Second
  s: /* @__PURE__ */ __name(function(date, token, localize) {
    if (token === "so") {
...
var dateLongFormatter = /* @__PURE__ */ __name((pattern, formatLong) => {
  switch (pattern) {
    case "P":
...
var timeLongFormatter = /* @__PURE__ */ __name((pattern, formatLong) => {
  switch (pattern) {
    case "p":
...
var dateTimeLongFormatter = /* @__PURE__ */ __name((pattern, formatLong) => {
...
__name(_Setter, "Setter");
var Setter = _Setter;
var _ValueSetter = class _ValueSetter extends Setter {
...
__name(_ValueSetter, "ValueSetter");
var ValueSetter = _ValueSetter;
var _DateToSystemTimezoneSetter = class _DateToSystemTimezoneSetter extends Setter {
  constructor() {
    super(...arguments);
...
__name(_DateToSystemTimezoneSetter, "DateToSystemTimezoneSetter");
var DateToSystemTimezoneSetter = _DateToSystemTimezoneSetter;
...
var _EraParser = class _EraParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_EraParser, "EraParser");
var EraParser = _EraParser;
...
var _YearParser = class _YearParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_YearParser, "YearParser");
var YearParser = _YearParser;

// node_modules/date-fns/parse/_lib/parsers/LocalWeekYearParser.mjs
var _LocalWeekYearParser = class _LocalWeekYearParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 130);
...
__name(_LocalWeekYearParser, "LocalWeekYearParser");
var LocalWeekYearParser = _LocalWeekYearParser;

// node_modules/date-fns/parse/_lib/parsers/ISOWeekYearParser.mjs
var _ISOWeekYearParser = class _ISOWeekYearParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 130);
    __publicField(this, "incompatibleTokens", [
...
__name(_ISOWeekYearParser, "ISOWeekYearParser");
var ISOWeekYearParser = _ISOWeekYearParser;

// node_modules/date-fns/parse/_lib/parsers/ExtendedYearParser.mjs
var _ExtendedYearParser = class _ExtendedYearParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 130);
...
__name(_ExtendedYearParser, "ExtendedYearParser");
var ExtendedYearParser = _ExtendedYearParser;

// node_modules/date-fns/parse/_lib/parsers/QuarterParser.mjs
var _QuarterParser = class _QuarterParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_QuarterParser, "QuarterParser");
var QuarterParser = _QuarterParser;

// node_modules/date-fns/parse/_lib/parsers/StandAloneQuarterParser.mjs
var _StandAloneQuarterParser = class _StandAloneQuarterParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 120);
    __publicField(this, "incompatibleTokens", [
...
__name(_StandAloneQuarterParser, "StandAloneQuarterParser");
var StandAloneQuarterParser = _StandAloneQuarterParser;

// node_modules/date-fns/parse/_lib/parsers/MonthParser.mjs
var _MonthParser = class _MonthParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "incompatibleTokens", [
      "Y",
  ...
  parse(dateString, token, match) {
    const valueCallback = /* @__PURE__ */ __name((value) => value - 1, "valueCallback");
    switch (token) {
      case "M":
        return mapValue(
...
__name(_MonthParser, "MonthParser");
var MonthParser = _MonthParser;

// node_modules/date-fns/parse/_lib/parsers/StandAloneMonthParser.mjs
var _StandAloneMonthParser = class _StandAloneMonthParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 110);
    __publicField(this, "incompatibleTokens", [
...
__name(_StandAloneMonthParser, "StandAloneMonthParser");
var StandAloneMonthParser = _StandAloneMonthParser;
...
var _LocalWeekParser = class _LocalWeekParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_LocalWeekParser, "LocalWeekParser");
var LocalWeekParser = _LocalWeekParser;
...
var _ISOWeekParser = class _ISOWeekParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 100);
    __publicField(this, "incompatibleTokens", [
...
__name(_ISOWeekParser, "ISOWeekParser");
var ISOWeekParser = _ISOWeekParser;
...
var _DateParser = class _DateParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_DateParser, "DateParser");
var DateParser = _DateParser;

// node_modules/date-fns/parse/_lib/parsers/DayOfYearParser.mjs
var _DayOfYearParser = class _DayOfYearParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 90);
    __publicField(this, "subpriority", 1);
...
__name(_DayOfYearParser, "DayOfYearParser");
var DayOfYearParser = _DayOfYearParser;
...
var _DayParser = class _DayParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 90);
...
__name(_DayParser, "DayParser");
var DayParser = _DayParser;

// node_modules/date-fns/parse/_lib/parsers/LocalDayParser.mjs
var _LocalDayParser = class _LocalDayParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 90);
    __publicField(this, "incompatibleTokens", [
  ...
  parse(dateString, token, match, options) {
    const valueCallback = /* @__PURE__ */ __name((value) => {
...
__name(_LocalDayParser, "LocalDayParser");
var LocalDayParser = _LocalDayParser;

// node_modules/date-fns/parse/_lib/parsers/StandAloneLocalDayParser.mjs
var _StandAloneLocalDayParser = class _StandAloneLocalDayParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 90);
    __publicField(this, "incompatibleTokens", [
...
__name(_StandAloneLocalDayParser, "StandAloneLocalDayParser");
var StandAloneLocalDayParser = _StandAloneLocalDayParser;
...
var _ISODayParser = class _ISODayParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 90);
    __publicField(this, "incompatibleTokens", [
...
__name(_ISODayParser, "ISODayParser");
var ISODayParser = _ISODayParser;

// node_modules/date-fns/parse/_lib/parsers/AMPMParser.mjs
var _AMPMParser = class _AMPMParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_AMPMParser, "AMPMParser");
var AMPMParser = _AMPMParser;

// node_modules/date-fns/parse/_lib/parsers/AMPMMidnightParser.mjs
var _AMPMMidnightParser = class _AMPMMidnightParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 80);
...
__name(_AMPMMidnightParser, "AMPMMidnightParser");
var AMPMMidnightParser = _AMPMMidnightParser;

// node_modules/date-fns/parse/_lib/parsers/DayPeriodParser.mjs
var _DayPeriodParser = class _DayPeriodParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 80);
...
__name(_DayPeriodParser, "DayPeriodParser");
var DayPeriodParser = _DayPeriodParser;

// node_modules/date-fns/parse/_lib/parsers/Hour1to12Parser.mjs
var _Hour1to12Parser = class _Hour1to12Parser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_Hour1to12Parser, "Hour1to12Parser");
var Hour1to12Parser = _Hour1to12Parser;

// node_modules/date-fns/parse/_lib/parsers/Hour0to23Parser.mjs
var _Hour0to23Parser = class _Hour0to23Parser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 70);
...
__name(_Hour0to23Parser, "Hour0to23Parser");
var Hour0to23Parser = _Hour0to23Parser;

// node_modules/date-fns/parse/_lib/parsers/Hour0To11Parser.mjs
var _Hour0To11Parser = class _Hour0To11Parser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 70);
...
__name(_Hour0To11Parser, "Hour0To11Parser");
var Hour0To11Parser = _Hour0To11Parser;

// node_modules/date-fns/parse/_lib/parsers/Hour1To24Parser.mjs
var _Hour1To24Parser = class _Hour1To24Parser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 70);
...
__name(_Hour1To24Parser, "Hour1To24Parser");
var Hour1To24Parser = _Hour1To24Parser;

// node_modules/date-fns/parse/_lib/parsers/MinuteParser.mjs
var _MinuteParser = class _MinuteParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_MinuteParser, "MinuteParser");
var MinuteParser = _MinuteParser;

// node_modules/date-fns/parse/_lib/parsers/SecondParser.mjs
var _SecondParser = class _SecondParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_SecondParser, "SecondParser");
var SecondParser = _SecondParser;

// node_modules/date-fns/parse/_lib/parsers/FractionOfSecondParser.mjs
var _FractionOfSecondParser = class _FractionOfSecondParser extends Parser {
  constructor() {
    super(...arguments);
  ...
  parse(dateString, token) {
    const valueCallback = /* @__PURE__ */ __name((value) => Math.trunc(value * Math.pow(10, -token.length + 3)), "valueCallback");
    return mapValue(parseNDigits(token.length, dateString), valueCallback);
  }
  set(date, _flags, value) {
...
__name(_FractionOfSecondParser, "FractionOfSecondParser");
var FractionOfSecondParser = _FractionOfSecondParser;

// node_modules/date-fns/parse/_lib/parsers/ISOTimezoneWithZParser.mjs
var _ISOTimezoneWithZParser = class _ISOTimezoneWithZParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_ISOTimezoneWithZParser, "ISOTimezoneWithZParser");
var ISOTimezoneWithZParser = _ISOTimezoneWithZParser;

// node_modules/date-fns/parse/_lib/parsers/ISOTimezoneParser.mjs
var _ISOTimezoneParser = class _ISOTimezoneParser extends Parser {
  constructor() {
    super(...arguments);
    __publicField(this, "priority", 10);
    __publicField(this, "incompatibleTokens", ["t", "T", "X"]);
...
__name(_ISOTimezoneParser, "ISOTimezoneParser");
var ISOTimezoneParser = _ISOTimezoneParser;

// node_modules/date-fns/parse/_lib/parsers/TimestampSecondsParser.mjs
var _TimestampSecondsParser = class _TimestampSecondsParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_TimestampSecondsParser, "TimestampSecondsParser");
var TimestampSecondsParser = _TimestampSecondsParser;

// node_modules/date-fns/parse/_lib/parsers/TimestampMillisecondsParser.mjs
var _TimestampMillisecondsParser = class _TimestampMillisecondsParser extends Parser {
  constructor() {
    super(...arguments);
...
__name(_TimestampMillisecondsParser, "TimestampMillisecondsParser");
var TimestampMillisecondsParser = _TimestampMillisecondsParser;
...
//# sourceMappingURL=chunk-CDXDDTSZ.js.map
