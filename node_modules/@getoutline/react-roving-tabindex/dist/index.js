    ...
    switch (action.type) {
        case exports.ActionType.REGISTER_TAB_STOP: {
            ...
            for (var i = state.tabStops.length - 1; i >= 0; --i) {
                ...
                if (loopTabStop.id === newTabStop.id) {
                    warning__default["default"](false, "'".concat(newTabStop.id, "' tab stop already registered"));
                    return state;
                }
        ...
        case exports.ActionType.UNREGISTER_TAB_STOP: {
            ...
            if (newTabStops.length === state.tabStops.length) {
                warning__default["default"](false, "'".concat(id_1, "' tab stop already unregistered"));
                return state;
            }
        ...
        case exports.ActionType.TAB_STOP_UPDATED: {
            ...
            if (index === -1) {
                warning__default["default"](false, "'".concat(id_2, "' tab stop not registered"));
                return state;
            }
        ...
        case exports.ActionType.FOCUSED: {
        ...
        case exports.ActionType.KEY_DOWN: {
            ...
            if (index === -1) {
                warning__default["default"](false, "'".concat(id_3, "' tab stop not registered"));
                return state;
            }
        ...
        case exports.ActionType.CLICKED: {
            ...
            if (index === -1) {
                warning__default["default"](false, "'".concat(id_4, "' tab stop not registered"));
                return state;
            }
            var currentTabStop = state.tabStops[index];
        ...
        case exports.ActionType.OPTIONS_UPDATED:
    ...
    switch (key) {
        ...
        case exports.EventKey.ArrowDown:
            if (isGrid) {
                ...
                return loopAround && isLast ? exports.Navigation.VERY_FIRST : exports.Navigation.NEXT;
            }
            return null;
...
var Provider = function (_a) {
    ...
    React.useEffect(function () {
        var _a, _b, _c;
        dispatch({
            type: exports.ActionType.OPTIONS_UPDATED,
            payload: {
...
function useRovingTabIndex(domElementRef, disabled, rowIndex) {
    ...
    React.useCallback(function (_ev) {
    ...
    React.useCallback(function (_ev) {
        context.dispatch({
            type: exports.ActionType.FOCUSED,
            payload: { id: getId() }
        });
    }, []);
