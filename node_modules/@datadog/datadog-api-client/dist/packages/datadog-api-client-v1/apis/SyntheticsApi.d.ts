...
export declare class SyntheticsApiRequestFactory extends BaseAPIRequestFactory {
    createGlobalVariable(body: SyntheticsGlobalVariable, _options?: Configuration): Promise<RequestContext>;
    ...
    editGlobalVariable(variableId: string, body: SyntheticsGlobalVariable, _options?: Configuration): Promise<RequestContext>;
